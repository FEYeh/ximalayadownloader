/* 迅雷下载 JS-SDK 1.15.2://open.thunderurl.com) */
window.thunderLink = (function (e) {
  ...
  function (e, t, n) {
    ...
    function o() {
      var e = navigator.userAgent.toLowerCase(),
        t = "unknown";
      return (
        /macintosh/i.test(e) && !navigator.maxTouchPoints
          ? (t = "Mac")
          : /iphone/i.test(e)
          ? (t = "iPhone")
          : /ipad/i.test(e) ||
    ...
    (t.detectIE = function () {
      ...
      (t.compileOpts = function (e) {
        var t = j_xunlei_q.extend({}, e),
          n = "";
        e = decodeURIComponent(j_xunlei_q.param(e)).split("&");
        for (var r = 0; r < e.length; r++) {
          var o = e[r].split("=");
          "undefined" !== o[1] &&
            (n += o.shift() + "=" + encodeURIComponent(o.join("=")));
        }
      ...
      (t.getUserBrowser = function () {
        ...
        return (
          ...
          (/chrome/i.test(e) ||
            /firefox/i.test(e) ||
            /Safari/i.test(e) ||
            /macThunderBrowser/i.test(e) ||
            /AppleWebKit/i.test(e))
            ? (t = "MacBrowser")
            : /android/i.test(e)
            ? (t = "Android")
            : (!/msie/i.test(e) && !/trident/i.test(e)) || /opera/.test(e)
            ? /firefox/i.test(e)
              ? (t = "Firefox")
              : /opera/i.test(e) || /opr/i.test(e)
              ? (t = "Opera")
              : /chrome/i.test(e) && /webkit/i.test(e) && /mozilla/i.test(e)
              ? (t = "Chrome")
              : !/webkit/i.test(e) ||
                /android/i.test(e) ||
                (/chrome/i.test(e) &&
      ...
      (t.gteWin7 = function () {
        var e =
          navigator.userAgent.toLowerCase().match(/windows nt (\d+\.\d+)/) ||
          [];
      ...
      (t.removeFdiv = function () {
        document.getElementById("fdiv") &&
          (navigator.userAgent.indexOf("MSIE") > 0
            ? document.getElementById("fdiv").removeNode(!0)
            : document
                .getElementById("fdiv")
                .parentNode.removeChild(document.getElementById("fdiv")));
      }),
      (t.versionCompare = function (e, t) {
        for (
          var n = e.split("."), i = t.split("."), r = 0, o = 0;
          o < n.length;
          o++
        ) {
          if (n[o] - i[o] > 0) {
      ...
      (t.wtdChangFolder = function (e) {
        return "http://down.sandai.net/thunderx/XunLeiWebSetupjs.exe";
      }),
      (t.getFileNameFromURL = function a(e) {
        ...
        else if (!0 === /^magnet:\/\//g.test(e))
          t = "%e7%a7%8d%e5%ad%90%e6%96%87%e4%bb%b6";
  ...
  function (e, t, n) {
    ...
    e.exports = {
      ...
      merge: function D() {
        ...
        for (var n = 0, i = arguments.length; n < i; n++) B(arguments[n], t);
        return e;
      },
    ...
    (t.downloadWithXlwfp = function (e, t) {
      ...
      (t.iPhoneDownload = function (e, t, n) {
        var o = window.location.href,
          B =
            i["default"].ios_call +
            "?action=sharePage&shareH5=share_H5&taskDownload=" +
              ...
              if (/(^http[s]?)|(^ftp)/.test(t)) {
                f("#*TDM-".concat(d(F.pid), "*#")),
                  (window.location.href =
                    r +
                    encodeURIComponent(
                      "xunlei://file/downloadAlert?url=".concat(
                        encodeURIComponent(t)
                      )
                    ));
              } else
                s.reportSend("page_pop", {
                  type: "yunpan_h5",
                  ...
                  a.openComfirm({
                    ...
                    comfirmHandler: function () {
                      s.reportSend("page_click", {
                        ...
                        (window.location.href = ""
                          .concat("https://pan.xunlei.com/", "?taskurl=")
  ...
  function (e, t, n) {
    ...
    function A(e, t) {
      ...
      return ".avi|.wmv|.mpeg|.mp4|.mov|.mkv|.flv|.f4v|.m4v|.rmvb|.rm|.3gp|.dat|.ts|.mts|.vob".indexOf(
        n
      ) > -1
        ? l.base64Header + l.video
        : ".mp3|.aac|.aiff|.amr|.m4p|.wav|.ogg|.raw|.dv".indexOf(n) > -1
        ? l.base64Header + l.music
        : ".txt|.docx|.pptx|.xlsx".indexOf(n) > -1
        ? l.base64Header + l.doc
        : ".exe|.ipa|.apk|.dmg|.bin|.pkg|.bat|.cmd|.com|.msi|.ins".indexOf(n) >
          -1
        ? l.base64Header + l.soft
        : ".zip|.rar|.iso|.tgz|.tar".indexOf(n) > -1
        ? l.base64Header + l.archive
        : ".png|.jpg|.bmp|.gif|.jpeg".indexOf(n) > -1
        ? l.base64Header + l.image
        : l.base64Header + l.unknown;
    }
    var c = null,
      F = {
        xlVersion: 0,
        ...
        generateTemplateForNotInstallOrNeedToUpate: function (e) {
          ...
          var C = D ? u : o || u,
            B = A(i, t),
            l =
              '<p class="xl_top_warning"><i class="icon_xl_warn icon_xl_success"></i>\u5df2\u83b7\u5f97\u4e0b\u8f7d\u94fe\u63a5</p>';
          "need_to_install_xmp" === r &&
            (l =
              '<p class="xl_top_warning"><i class="icon_xl_warn icon_xl_success"></i>\u5df2\u83b7\u5f97\u89c6\u9891\u4fe1\u606f</p>');
          var c = "\u5b89\u88c5\u8fc5\u96f711\u5f00\u59cb\u4e0b\u8f7d";
          "need_to_update_on_win" === r &&
            ((l =
              '<p class="xl_top_warning"><i class="icon_xl_warn icon_xl_error"></i>\u65e7\u7248\u8fc5\u96f7\u65e0\u6cd5\u83b7\u5f97\u4e0b\u8f7d\u94fe\u63a5</p>'),
            (c =
              "\u5347\u7ea7\u8fc5\u96f711&nbsp;&nbsp;\u5f00\u59cb\u4e0b\u8f7d")),
            "need_to_install_xmp" === r &&
              (c =
          ...
          "need_to_install_xmp" === r
            ? (F =
                '<div class="xl_wp_downmkv"><p class="xl_tip_downmkv" id="js_xl_manual_download_prompt" style = "font-size: 12px">\u5982\u60a8\u5df2\u5b89\u88c5\u8fc5\u96f7\u6216\u8005\u8fc5\u96f7\u5f71\u97f3<a href="javascript:;" class="link" id="js_xl_manual_lunach_xmp">\u70b9\u51fb\u8fd9\u91cc\u5f00\u59cb\u64ad\u653e</a></p>  <div class="xl_downmkv_tip">                 <p style = "font-size: 12px">\u5982\u672a\u5b89\u88c5\u8fc5\u96f711\u6216\u8fc5\u96f7\u5f71\u97f3<br>\u70b9\u51fb\u5c06\u65e0\u6548</p>               </div>            </div> ')
            : "need_to_update_on_win" !== r &&
              (F =
                !1 === i && !0 !== s
                  ? '<p class="xl_tip_downmkv" id="js_xl_manual_download_prompt" style = "font-size: 12px">\u5982\u60a8\u5df2\u5b89\u88c5\u8fc5\u96f7<a href="' +
                    C +
                    '" class="link" id="js_xl_manual_download_btn">\u70b9\u51fb\u8fd9\u91cc\u5f00\u59cb\u4e0b\u8f7d</a></p>'
                  : '<div class="xl_wp_downmkv">              <p class="xl_tip_downmkv" style = "font-size: 12px">\u5982\u60a8\u5df2\u7ecf\u5b89\u88c5\u8fc5\u96f711<a style = "font-size: 12px" href="' +
                    C +
                    '" class="js-xl-link link" id="js_xl_manual_download_btn">\u70b9\u51fb\u8fd9\u91cc\u5f00\u59cb\u4e0b\u8f7d</a></p>              <div class="xl_downmkv_tip">                 <p style = "font-size: 12px">\u5982\u672a\u5b89\u88c5\u6700\u65b0\u7248\u8fc5\u96f711<br>\u70b9\u51fb\u5c06\u65e0\u6548</p>               </div>            </div> ');
          var d = "",
            h = 0;
          if (E)
            (h = 408),
              (d =
                '        <div class="xl_video_bot_pop">          <div class="xl_wp_download" style="margin-bottom: 20px">            <div class="xl_img_download"><img src="' +
                B +
                '" width="100%" height="100%" alt=""></div>            <p class="xl_info_download" id="js_xl_filename">' +
                t +
                ...
                (o || "javascript:") +
                '" class="link" id="js_xl_manual_download_btn"><img class="xlx_pop_play_icon" src="' +
                n(32) +
                '">\u5f00\u59cb\u4e0b\u8f7d</a>            </div>            <div class="xl_bot_item">               <div class="xl-icon-wrap">                   <span class="xl_production xmp"/>                   <span class="xl_production_name">\u8fc5\u96f7\u5f71\u97f3</span>               </div>               <p class="xl_pop_download"><a class="xl_pop_btn_link" id="js_xmp_download_btn" id="js_xmp_download_btn">\u4e0b\u8f7d\u5ba2\u6237\u7aef</a><p>               <p class="xl_pop_installed">\u5df2\u6709\u8fc5\u96f7\u5f71\u97f3</p>               <a title="\u5982\u672a\u5b89\u88c5\u8fc5\u96f7\u5f71\u97f36.0\u4ee5\u4e0a\u7248\u672c\uff0c\u65e0\u6cd5\u8fdb\u884c\u64ad\u653e" class="xlx_pop_play" id="js_xmp_manual_download_btn"><img class="xlx_pop_play_icon"  src="' +
                n(33) +
                '">\u7acb\u5373\u64ad\u653e</a>            </div>            <div class="xl_bot_item">               <div class="xl-icon-wrap">                   <span class="xl_production sl"/>                   <span class="xl_production_name">\u624b\u673a\u8fc5\u96f7</span>               </div>               <div class="xl_pop_download"><a class="xl_pop_btn_link" style="background:#4B87FF"><img style="vertical-align: middle;" class="xlx_pop_play_icon" src="' +
                n(34) +
                '">\u626b\u7801\u4e0b\u8f7d</a>                <div class="xl_downapp_tip">                    <div class="xl_img_code" id="js_xl_popup_qrcode" style="padding:10px"> </div>                </div>               </div>            </div>          </div>        </div>'),
              a.reportSend("pc_qrcode_show", { qr_from: "auto" }),
              j_xunlei_q("body").undelegate(".tip_app");
          else if ("need_to_install_xmp" === r) {
            (d =
              '        <div class="xl_bot_pop">          <div class="xl_wp_download">            <div class="xl_img_download"><img src="' +
              B +
              '" width="100%" height="100%" alt=""></div>            <p class="xl_info_download" style="text-align:left" x-ms-format-detection="none">' +
              t +
              '            </p>          </div>          <a href="http://xmp.down.sandai.net/xmp/XMPSetup6.0.10.488xl.exe" target="_blank" class="xl_btn btn_download" id="js_xmp_download_btn"><i class="icon_xmp_logo"></i><span>' +
              c +
              '            </span></a>      <div class="xl_bot_tip">            <div class="xl_wp_downapp">' +
              '<p class="tip_app" style = "font-size: 12px"><i class="icon_xl_phone"></i><span style="color:black;" class="tip_mobile_download">\u624b\u673a\u4e0b\u8f7d</span></p> <div class="xl_downapp_tip" style="top:40px;margin-left: -63px;"><div  class="xl_img_code" id="js_xl_popup_qrcode" style="padding: 20px"> </div></div>' +
              " </div>" +
              F +
              " </div></div>    </div>"),
              (h = 325),
              j_xunlei_q("body").delegate(
                ".tip_app",
                "mouseenter",
                function () {
                  a.reportSend("pc_qrcode_show", { qr_from: "hover" });
                }
              );
          } else {
            (d =
              ...
              '" width="100%" height="100%" alt=""></div>            <p class="xl_info_download" id="js_xl_filename">' +
              t +
              '            </p>          </div>          <a href="javascript:;" class="xl_btn btn_download" id="js_xl_download_btn"><i class="icon_xl_logo"></i><span>' +
              c +
              '            </span></a>      <div class="xl_bot_tip">            <div class="xl_wp_downapp">' +
              '<p class="tip_app" style = "font-size: 12px"><i class="icon_xl_phone"></i><span style="color:black;" class="tip_mobile_download">\u624b\u673a\u4e0b\u8f7d</span></p> <div class="xl_downapp_tip" style="top:40px;margin-left: -63px;"><div  class="xl_img_code" id="js_xl_popup_qrcode" style="padding: 20px"> </div></div>' +
              " </div>" +
          ...
          return (
            '<div id="js_xl_popup_template" style="position: fixed; width:100%;height:100%; top:0;left:0;"><div class="xl_pop_tip" style="height:' +
            h +
            'px" >    <div class="xl_main_tip">        <div class="xl_top_pop">            <div class="xl_head_pop">                <h3 class="xl_tit" style="text-align:left" >\u4e0b\u8f7d\u63d0\u793a</h3>                <div class="xl_wp_downjs">                    <a  href="https://open.thunderurl.com/#/" target="_blank" class="xl_btn_downjs"><i></i></a>                    <div class="xl_wp_downjs_tip">                        <p>\u70b9\u51fb\u4e86\u89e3\u201c\u8fc5\u96f7\u4e0b\u8f7dJS-SDK\u201d </p>                    </div>                </div>                <a href="javascript:;" class="xl_btn_clo hide_txt" id="js_xl_close_btn_of_not_install" clickid="windowclose">\u5173\u95ed<i></i></a>            </div>' +
            l +
            "        </div>" +
            d +
            "  </div>"
        ...
        popup: function (e, t, n, r) {
          if ((F.hidnAllPopup(), "old_browser_on_win" === e))
            alert(
              "\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u6b64\u529f\u80fd\uff0c\u5efa\u8bae\u60a8\u4f7f\u7528Chrome\u6d4f\u89c8\u5668\uff0c\u6216\u4f7f\u7528360\u6d4f\u89c8\u5668\u3001 QQ\u6d4f\u89c8\u5668\u7b49Chrome\u5185\u6838\u7684\u6d4f\u89c8\u5668"
            );
          else if ("old_system_on_win" === e)
            alert(
              "\u60a8\u6b63\u5728\u4f7f\u7528\u7684\u64cd\u4f5c\u7cfb\u7edf\u7248\u672c\u8001\u65e7\uff0c \u6682\u4e0d\u652f\u6301\u8fc5\u96f7\u6279\u91cf\u4e0b\u8f7d"
            );
          else {
            var E = function (E) {
                var s = "";
                "string" == typeof t
                  ? (s = t)
                  : t && t.getAttribute(i) && (s = t.getAttribute(i));
                ...
                j_xunlei_q("body").append(C),
                  "need_to_update_on_win" === e
                    ? j_xunlei_q("#js_xl_download_btn").attr(
                        "clickid",
                        "window_pop_update"
                      )
                    : j_xunlei_q("#js_xl_download_btn").attr(
                ...
                "need_to_update_on_win" === e && (l = "update"),
                  ...
                  j_xunlei_q("#js_xmp_download_btn").bind("click", function () {
                    F.downloadXmp(F.pid);
                    var e = j_xunlei_q("#js_xmp_download_btn").attr("clickid");
                    return (
                      void 0 === e && (e = "window_pop_downloadxmp"),
                  ...
                  j_xunlei_q("#js_xmp_manual_download_btn").bind(
                    "click",
                    function () {
                      try {
                        if (n) B.playWithXmp({ tasks: F.tasks });
                        else {
                          var e = j_xunlei_q("#js_xl_filename").text(),
                            t = j_xunlei_q(
                              "#js_xl_manual_download_prompt"
                            ).attr("href");
                          B.playWithXmp({ tasks: [{ name: e, url: t }] });
                        }
                        a.reportSend("page_click", {
              ...
              u = !1;
            F.xlVersion
              ? ((C(F.xlVersion, "10.1.1.0") > 0 ||
                  C(F.xlVersion, "9.0.0.0") < 0) &&
                  (u = D && "need_to_install_xmp" !== e),
                E(u))
              : E((u = D && "need_to_install_xmp" !== e));
          }
        },
        ...
        copyText: function (e) {
          if (!("IE" === E() && s.getIEVersion() < 9)) {
            ...
            t.isSupported() &&
              (null != c && c.destroy(),
              (c = new t(".btn_download, .js-xl-link", {
                text: function () {
                  return e;
                },
              })));
        ...
        downloadXl: function (e) {
          if (
            void 0 !== F.thunderInstallPack &&
            /^\s*https?:\/\/(.+?\.)?down\.sandai\.net/gi.test(
              F.thunderInstallPack
            )
          )
            top.location.href = F.thunderInstallPack;
          else {
            var t = r(e);
            top.location.href = t;
          }
        ...
        init: function (e) {
          (F.pid = e),
            j_xunlei_q("body").delegate(
              ...
              function () {
                setTimeout(function () {
                  ...
                  return (
                    void 0 === t && (t = "windowbtn_install"),
                    a.reportSend("page_click", { clickid: t }),
                    F.hidnAllPopup(),
                    !1
                  );
                }, 0);
            ...
            j_xunlei_q("body").delegate(
              "#js_xl_close_btn_of_not_install",
              "click",
              function () {
                return (
                  F.hidnAllPopup(),
                  a.reportSend("page_click", { clickid: "windowclose" }),
                  !1
                );
              }
            ),
        ...
        openComfirm: function (e) {
          ...
          (r.innerHTML = t),
            ...
            j_xunlei_q(".xl_ios_comfirm_wrapper .closeBtn").one(
              "click",
              function (e) {
                "function" == typeof n &&
                  (n(e), j_xunlei_q(".xl_ios_comfirm_wrapper").remove());
              }
            ),
            j_xunlei_q(".xl_ios_comfirm_wrapper .save").one(
              "click",
              function (e) {
                "function" == typeof n &&
                  (j_xunlei_q(".xl_comfirm_wrapper").remove(),
                  j_xunlei_q(".xl_ios_comfirm_wrapper").remove(),
                  i(e));
              }
            );
        },
      };
    (t.Dialog = F), (t.getFieIconBase64Data = A);
  },
  function (e, t, n) {
    var i = n(8),
    ...
    (xla = window.xla || (window.xla = [])),
      xla.push({
        type: "globalExtData",
        data: { clientType: s, sourceType: "lianmeng" },
      }),
      xla.push({
        type: "config",
        appid: 20021,
  ...
  function (e, t) {
    ...
    function r(e) {
      var t,
        ...
        B = 0;
      do {
        (r = (t = e.charCodeAt(B++)) >> 2),
          (o = ((3 & t) << 4) | ((n = e.charCodeAt(B++)) >> 4)),
          (a = ((15 & n) << 2) | ((s = e.charCodeAt(B++)) >> 6)),
          (C = 63 & s),
          isNaN(n) ? (a = C = 64) : isNaN(s) && (C = 64),
          (E = E + i.charAt(r) + i.charAt(o) + i.charAt(a) + i.charAt(C)),
          (t = n = s = ""),
          (r = o = a = C = "");
      } while (B < e.length);
      return E;
      ...
      (t.decode64 = function (e) {
        ...
        do {
          (t =
            ...
            ((r = i.indexOf(e.charAt(C++))) >> 4)),
            (n = ((15 & r) << 4) | ((o = i.indexOf(e.charAt(C++))) >> 2)),
            (E = ((3 & o) << 6) | (s = i.indexOf(e.charAt(C++)))),
            (a += String.fromCharCode(t)),
            64 != o && (a += String.fromCharCode(n)),
            64 != s && (a += String.fromCharCode(E)),
            (t = n = E = ""),
            (r = o = s = "");
        } while (C < e.length);
        return a;
  ...
  function (e, t) {
    e.exports = { exceptPath: "", pid: "11111" };
  },
  function (e, t, n) {
  ...
  function (e, t, n) {
    ...
    (E.createUrlByParam = function (e, t) {
      ...
      (E.createQrcode = (function () {
        var e = {},
          t =
            "http://mobile.xunlei.com/m/channel.html?from=ThunderLink_PCPopUp";
        return function (n, r) {
          var o = (r = r || {}).size || 90,
            s = r.text || t,
            C = r.download || "";
          "" !== C &&
            (s = E.createUrlByParam(s, {
              taskDownload: C,
              scheme: "xunleiapp://xunlei.com/sharePage?shareH5=share_H5",
            }));
          var B = s;
          if (e[s]) return (B = e[s]), void F();
          var D = !1,
            ...
            A = a.getIEVersion(),
            c =
              ("IE" == l && A < 10 ? "http" : "https") +
              "://api-shoulei-ssl.xunlei.com/xlppc.dljgo.api/v2/create";
          function F() {
            ...
            function (e, t) {
              return (
                ...
                i.isBlob(e)
                  ...
                  ? (E(t, "application/x-www-form-urlencoded;charset=utf-8"),
                    e.toString())
                  : i.isObject(e) ||
                    (t && "application/json" === t["Content-Type"])
                  ? (E(t, "application/json"), JSON.stringify(e))
                  : e
              );
            },
          ],
  ...
  function (e, t, n) {
    ...
    t.productAndroidShow = function (e, t) {
      ...
      return (
        ...
        -1 === navigator.userAgent.indexOf("Android.Thunder") &&
          (function () {
            ...
            if (r.length > 0) {
              var o = r.eq(0);
              o.attr("content").indexOf("initial-scale=1") < 0 &&
                (o.attr("content", "width=device-width, initial-scale=1"),
                o.attr(
                  "content",
                  "width=device-width, initial-scale=" + 1 / e
                ));
            } else
              j_xunlei_q("head").prepend(
                '<meta name="viewport" content="width=device-width, initial-scale=' +
            ...
            (A.innerHTML = a),
              ...
              j_xunlei_q("#thunder_dl_shoulei")
                .unbind("click")
                .click(function () {
                  C.reportSend("page_click", { clickid: "download" }), F();
                }),
              j_xunlei_q("#union_download_close")
                .unbind("click")
                .click(function (e) {
                  C.reportSend("page_click", { clickid: "close" }),
                    d(),
                    e.stopPropagation();
                }),
      ...
      function c() {
        return (
          C.reportSend("page_click", { clickid: "launch" }),
      ...
      function F() {
        ...
        E.server &&
          (E.server[l]
            ? E.server[l].apk && (i = E.server[l].apk)
            : E.server[n] && E.server[n].apk && (i = E.server[n].apk)),
          (window.location.href = e);
        var r = Date.now();
        return (
          t && clearTimeout(t),
  ...
  function (e, t, n) {
    ...
    function C(e, t, n, i) {
      ...
      function C() {
        a(), (top.location.href = "http://down.sandai.net/mac/thunder_mac.dmg");
      }
      function B() {
        a(),
          setTimeout(function () {
    ...
    (t.newMacTasks = function (e, t) {
      function r(e) {
        var t = n(12);
        t.isSupported() &&
          (s = new t(".btn_launch_mac_thunder", {
            text: function () {
              return e;
            },
          }));
      ...
      if (null != e.tasks && "object" === i(e.tasks)) {
        if (
          1 == e.tasks.length &&
          null != e.tasks[0].url &&
          /^\s*thunder:\/\//gi.test(e.tasks[0].url)
        )
          C(e.tasks[0].url, 0, !1, t);
      ...
      a.reportSend("page_pop", { clickid: "productMacShow" });
    }),
      (t.productMacShow = C);
  },
  function (e, t) {
    ...
    function u() {
      B &&
        s &&
        ((B = !1), s.length ? (C = s.concat(C)) : (D = -1), C.length && l());
    }
    function l() {
      if (!B) {
        var e = E(u);
    ...
    (r.nextTick = function (e) {
      ...
      C.push(new A(e, t)), 1 !== C.length || B || E(l);
    }),
        ...
        return new t(function (t, n) {
          ...
          if (
            (A.open(
              ...
              a(d, e.params, e.paramsSerializer),
              !0
            ),
            (A.timeout = e.timeout),
            "onloadend" in A
            ...
            (A.onerror = function () {
              n(B("Network Error", e, null, A)), (A = null);
            }),
            ...
            var p =
              (e.withCredentials || C(d)) && e.xsrfCookieName
  ...
  function (e, t, n) {
    ...
    function b(e) {
      ...
      t &&
        t.addEventListener("click", function () {
          a(
            { thunderPid: l.pid, tasks: e.tasks },
            function () {},
            function () {}
          ),
    ...
    (y.config = function (e) {
      e.pid && (l.pid = e.pid), e.exceptPath && (l.exceptPath = e.exceptPath);
    }),
      (y.newTask = function (e) {
        (window.__referer__ = e.referer), (e = j_xunlei_q.extend({}, e));
        var t = d(),
          n = F.getIEVersion(),
          a = h(),
          B = !1,
          ...
          c = "";
        if (
          (void 0 !== e.thunderInstallPack &&
          /^\s*https?:\/\/(.+?\.)?down\.sandai\.net/gi.test(
            e.thunderInstallPack
          )
            ? (g.thunderInstallPack = e.thunderInstallPack)
            : (g.thunderInstallPack = void 0),
          void 0 !== e.json && -1 !== e.json.indexOf("http"))
        )
          (B = !0),
            (A = !0),
          ...
          if (
            (!0 === (A = e.tasks.length > 1)
              ? null != e.taskGroupName &&
                "" != e.taskGroupName &&
                ((c = e.taskGroupName), (B = !0))
              : null != e.tasks[0].name &&
                "" != e.tasks[0].name &&
                (c = e.tasks[0].name),
            "" === c && null != e.tasks[0].url)
          ) {
            var y = e.tasks[0].url;
          ...
          for (var b = 0; b < e.tasks.length; b++)
            (e.tasks[b].originUrl = e.tasks[b].url),
        ...
        try {
          r.get(
            ...
            if (r.data.data.is_exist)
              A
                ? alert(
                    "\u672a\u652f\u6301\u6279\u91cf\u4e0b\u8f7d\u529f\u80fd\uff0c\u8bf7\u671f\u5f85\u540e\u7eed\u66f4\u65b0\u7684\u7248\u672c\u3002"
                  )
                : s(e.tasks[0].url, e.tasks[0].originUrl, c, l.pid);
            else if ("iPhone" == a || "iPad" == a || "iPod" == a)
              A
                ? alert(
                    "\u624b\u673a\u8fc5\u96f7\u6682\u672a\u652f\u6301\u6279\u91cf\u4e0b\u8f7d\u529f\u80fd\uff0c\u8bf7\u671f\u5f85\u540e\u7eed\u66f4\u65b0\u7684\u7248\u672c\u3002"
                  )
                : E(e.tasks[0].url, e.tasks[0].originUrl, c);
              ...
              A
                ...
                : D.productAndroidShow(e.tasks[0].url, l.pid);
            else if (p() && (("IE" === t && n > 9) || "IE" !== t)) {
              var F = location.href.substring(0, 5);
              if ("IE" === t && "https" === F && n < 12)
                return (
              ...
              C(l.pid, function (t) {
                var n = e.minVersion;
                if (
                  ((void 0 !== n && 0 != /^\d+\.\d+\.\d+(?:\.\d+)?$/.test(n)) ||
                    (n = "10.0.1.0"),
                  t && f(t, n) >= 0)
                )
                  if (void 0 !== e.json && -1 !== e.json.indexOf("http"))
                    o({ json: e.json, thunderPid: l.pid });
                  else {
                    var i = {
                    ...
                    void 0 !== e.userAgent && (i.userAgent = e.userAgent),
                      void 0 !== e.threadCount &&
                        (i.threadCount = e.threadCount),
                      o(i);
                  }
                else
                  t && f(t, "9.0.0.0") >= 0
              ...
              A
                ? p()
                  ? g.popup("old_browser_on_win")
                  : g.popup("old_system_on_win")
                : i.windowsDefaultHandler(e.tasks[0].url, l.pid),
                g.copyText("thunderx://" + JSON.stringify(e));
          });
        } catch (e) {
          console.error("err: ", e);
      ...
      (y.playWithXmp = function (e) {
        (window.__referer__ = e.referer),
          B(l.pid, function (t) {
            ...
            (void 0 !== n && 0 != /^\d+\.\d+\.\d+(?:\.\d+)?$/.test(n)) ||
              (n = "6.0.1.0"),
              f(t, n) >= 0 && a({ thunderPid: l.pid, tasks: e.tasks });
          });
      }),
      (y.downAndPlayWithXmp = function (e) {
        if (
          ((window.__referer__ = e.referer),
          !(e && e.tasks && e.tasks[0] && e.tasks[0].url))
        )
        ...
        if (!p())
          return "MacBrowser" == t
            ? alert(
                "Mac OS\u6682\u4e0d\u652f\u6301\u5728\u7ebf\u64ad\u653e\u672c\u89c6\u9891\uff0c\u8bf7\u4e0b\u8f7d\u540e\u64ad\u653e\uff01"
              )
            : alert(
                "\u79fb\u52a8\u8bbe\u5907\u6682\u4e0d\u652f\u6301\u5728\u7ebf\u64ad\u653e\u672c\u89c6\u9891\uff0c\u8bf7\u4e0b\u8f7d\u540e\u64ad\u653e\uff01"
              );
        a(
          { thunderPid: l.pid, tasks: e.tasks },
          function (t) {
  ...
  function (e, t) {
    ...
    !(function (e, t) {
      ...
      function r(e, t) {
        t.src
          ? p.ajax({ url: t.src, async: !1, dataType: "script" })
      ...
      function o(e, i, r, a, E, s) {
        ...
        if (r !== t) {
          for (a = !s && a && p.isFunction(r), B = 0; B < C; B++)
            E(e[B], i, a ? r.call(e[B], B, E(e[B], i)) : r, s);
          return e;
        }
        return C ? E(e[0], i) : t;
      }
      ...
      function B(e) {
        ...
        if (
          ...
          for (o = 0; o < D.length; o++)
            (i = D[o]).origType.replace(q, "") === e.type
              ? C.push(i.selector)
              : D.splice(o--, 1);
          for (
            a = 0, E = (n = p(e.target).closest(C, e.currentTarget)).length;
            a < E;
            a++
          )
            for (o = 0; o < D.length; o++)
              (i = D[o]),
                n[a].selector === i.selector &&
                  ((r = n[a].elem),
                  (C = null),
                  ("mouseenter" !== i.preType && "mouseleave" !== i.preType) ||
                    (C = p(e.relatedTarget).closest(i.selector)[0]),
                  (C && C === r) || s.push({ elem: r, handleObj: i }));
          for (a = 0, E = s.length; a < E; a++)
            if (
              ...
              !1 === n.handleObj.origHandler.apply(n.elem, B))
            ) {
              t = !1;
              break;
            }
        ...
        t.each(function () {
          if (this.nodeName === (e[n] && e[n].nodeName)) {
            var t = p.data(e[n++]),
              i = p.data(this, t);
            if ((t = t && t.events))
              for (var r in (delete i.handle, (i.events = {}), t))
                for (var o in t[r]) p.event.add(this, r, t[r][o], t[r][o].data);
          }
        });
      }
      function A(e, t, n) {
        var i, r, o;
        return (
          (t = t && t[0] ? t[0].ownerDocument || t[0] : v),
          1 === e.length &&
            "string" == typeof e[0] &&
            e[0].length < 512 &&
            t === v &&
            !Ae.test(e[0]) &&
            (p.support.checkClone || !ce.test(e[0])) &&
            ((r = !0), (o = p.fragments[e[0]]) && 1 !== o && (i = o)),
      ...
      function c(e, t) {
        var n = {};
        return (
          p.each(Ze.concat.apply([], Ze.slice(0, t)), function () {
            n[this] = e;
          }),
          n
        );
      ...
      (p.fn = p.prototype =
        {
          init: function (e, n) {
            ...
            if ("string" == typeof e) {
              ...
              if (i[1])
                return (
                  (r = n ? n.ownerDocument || n : v),
                  (e = w.exec(e))
                    ? p.isPlainObject(n)
                      ? ((e = [v.createElement(e[1])]),
                        p.fn.attr.call(e, n, !0))
                      : (e = [r.createElement(e[1])])
                    : (e = (
                        (e = A([i[1]], [r])).cacheable
                          ? e.fragment.cloneNode(!0)
                          : e.fragment
                      ).childNodes),
                  p.merge(this, e)
                );
          ...
          pushStack: function (e, t, n) {
            var i = p();
            return (
              p.isArray(e) ? S.apply(i, e) : p.merge(i, e),
              (i.prevObject = this),
          ...
          ready: function (e) {
            return (
              p.bindReady(), p.isReady ? e.call(v, p) : j && j.push(e), this
            );
          },
          eq: function (e) {
        ...
        (p.extend = p.fn.extend =
          function () {
            ...
            for (
              "boolean" == typeof a &&
                ((C = a), (a = arguments[1] || {}), (E = 2)),
                "object" === n(a) || p.isFunction(a) || (a = {}),
                s === E && ((a = this), --E);
              E < s;
              E++
            )
              if (null != (e = arguments[E]))
                for (i in e)
                  e.hasOwnProperty(i) &&
                    ((r = a[i]),
                    a !== (o = e[i]) &&
                      (C && o && (p.isPlainObject(o) || p.isArray(o))
                        ? ((r =
                            r && (p.isPlainObject(r) || p.isArray(r))
                              ? r
                              : p.isArray(o)
                              ? []
                              : {}),
        ...
        p.extend({
          ...
          bindReady: function () {
            if (!k) {
              ...
              if (v.addEventListener)
                v.addEventListener("DOMContentLoaded", h, !1),
            ...
            if (e && y.test(e)) {
              ...
              (n.type = "text/javascript"),
                p.support.scriptEval
                  ? n.appendChild(v.createTextNode(e))
                  : (n.text = e),
          ...
          each: function (e, n, i) {
            ...
            if (i)
              ...
              for (r in e)
                if (e.hasOwnProperty(r) && !1 === n.call(e[r], r, e[r])) break;
          ...
          makeArray: function (e, t) {
            return (
              ...
              null != e &&
                ...
                "string" == typeof e ||
                p.isFunction(e) ||
                ("function" != typeof e && e.setInterval)
                  ? S.call(t, e)
                  : p.merge(t, e)),
              t
            );
          ...
          merge: function (e, n) {
            ...
            if ("number" == typeof n.length)
              for (var o = n.length; r < o; r++) e[i++] = n[r];
        ...
        (x = p.uaMatch(x)).browser &&
          ((p.browser[x.browser] = !0), (p.browser.version = x.version)),
        ...
        v.addEventListener
          ? (h = function () {
              v.removeEventListener("DOMContentLoaded", h, !1), p.ready();
            })
          : v.attachEvent &&
            (h = function () {
              "complete" === v.readyState &&
                (v.detachEvent("onreadystatechange", h), p.ready());
            }),
        (function () {
          p.support = {};
          ...
          if (o && o.length && E) {
            (p.support = {
              ...
              parentNode:
                null ===
                i.removeChild(i.appendChild(v.createElement("div"))).parentNode,
              deleteExpando: !0,
              checkClone: !1,
              scriptEval: !1,
              noCloneEvent: !0,
            ...
            t.removeChild(n),
              i.attachEvent &&
                i.fireEvent &&
                (i.attachEvent("onclick", function a() {
                  (p.support.noCloneEvent = !1), i.detachEvent("onclick", a);
                }),
                i.cloneNode(!0).fireEvent("onclick")),
              ((i = v.createElement("div")).innerHTML =
                "<input type='radio' name='radiotest' checked='checked'/>"),
              (t = v.createDocumentFragment()).appendChild(i.firstChild),
              (p.support.checkClone = t
                .cloneNode(!0)
      ...
      p.extend({
        ...
        data: function (i, r, o) {
          if (!i.nodeName || !p.noData[i.nodeName.toLowerCase()]) {
            var a = (i = i == e ? R : i)[P],
              E = p.cache;
            return a || "string" != typeof r || o !== t
              ? (a || (a = ++M),
                "object" === n(r)
                  ? ((i[P] = a), (E[a] = p.extend(!0, {}, r)))
                  : E[a] || ((i[P] = a), (E[a] = {})),
                (i = E[a]),
                o !== t && (i[r] = o),
                "string" == typeof r ? i[r] : i)
              : null;
          }
        },
        removeData: function (t, n) {
          if (!t.nodeName || !p.noData[t.nodeName.toLowerCase()]) {
            var i = (t = t == e ? R : t)[P],
              ...
              o = r[i];
            n
              ? o && (delete o[n], p.isEmptyObject(o) && p.removeData(t))
              : (p.support.deleteExpando
                  ? delete t[p.expando]
                  : t.removeAttribute && t.removeAttribute(p.expando),
                delete r[i]);
          }
        },
      }),
        p.fn.extend({
          data: function (e, i) {
            ...
            if (((r[1] = r[1] ? "." + r[1] : ""), i === t)) {
              ...
              return (
                o === t && this.length && (o = p.data(this[0], e)),
                o === t && r[1] ? this.data(r[0]) : o
              );
            }
            return this.trigger("setData" + r[1] + "!", [r[0], i]).each(
              function () {
                p.data(this, e, i);
              }
            );
      ...
      p.fn.extend({
        ...
        addClass: function (e) {
          ...
          if (e && "string" == typeof e)
            for (
              var t = (e || "").split(G), n = 0, i = this.length;
              n < i;
              n++
            ) {
              var r = this[n];
        ...
        removeClass: function (e) {
          ...
          if ((e && "string" == typeof e) || e === t)
            for (
              var n = (e || "").split(G), i = 0, r = this.length;
              i < r;
              i++
            ) {
              var o = this[i];
        ...
        toggleClass: function (e, t) {
          ...
          return p.isFunction(e)
            ...
            : this.each(function () {
                if ("string" === i)
                  for (
                    var n, o = 0, a = p(this), E = t, s = e.split(G);
                    (n = s[o++]);
                  ...
                  ("undefined" !== i && "boolean" !== i) ||
                    (this.className &&
                      p.data(this, "__className__", this.className),
                    (this.className =
                      this.className || !1 === e
                        ? ""
                        : p.data(this, "__className__") || ""));
              });
        },
        hasClass: function (e) {
          e = " " + e + " ";
          for (var t = 0, n = this.length; t < n; t++)
            if ((" " + this[t].className + " ").replace(L, " ").indexOf(e) > -1)
              return !0;
          return !1;
        },
        val: function (e) {
          if (e === t) {
            ...
            if (n) {
              ...
              return Z.test(n.type) && !p.support.checkOn
          ...
          return this.each(function (t) {
            ...
            if (1 === this.nodeType)
              if (
                (s && (i = e.call(this, t, n.val())),
                "number" == typeof i && (i += ""),
                p.isArray(i) && Z.test(this.type))
              )
                this.checked = p.inArray(n.val(), i) >= 0;
            ...
            if (((n = (r && p.props[n]) || n), 1 === e.nodeType)) {
              ...
              return n in e && r && !a
                ? (o &&
                    ...
                    (e[n] = i)),
                  p.nodeName(e, "form") && e.getAttributeNode(n)
                    ? e.getAttributeNode(n).nodeValue
                    : "tabIndex" === n
                    ? (n = e.getAttributeNode("tabIndex")) && n.specified
                      ? n.value
                      : W.test(e.nodeName) || (H.test(e.nodeName) && e.href)
                      ? 0
                      : t
                    : e[n])
                : !p.support.style && r && "style" === n
                ? (o && (e.style.cssText = "" + i), e.style.cssText)
                : (o && e.setAttribute(n, "" + i),
                  null ===
                  (e =
                    !p.support.hrefNormalized && r && a
                      ? e.getAttribute(n, 2)
                      : e.getAttribute(n))
                    ? t
                    : e);
      ...
      p.event = {
        add: function (n, i, r, o) {
          ...
          if (
            ...
            r.handler && (r = (a = r).handler),
            r.guid || (r.guid = p.guid++),
            (E = p.data(n)))
          ) {
            ...
            C ||
              (E.handle = C =
                function () {
                  return void 0 === p || p.event.triggered
                    ? t
                    : p.event.handle.apply(C.elem, arguments);
                }),
              (C.elem = n),
              (i = i.split(" "));
            for (var B, D, u = 0; (B = i[u++]); ) {
              (E = a ? p.extend({}, a) : { handler: r, data: o }),
                B.indexOf(".") > -1
                  ? ((D = B.split(".")),
                    (B = D.shift()),
                    (E.namespace = D.slice(0).sort().join(".")))
                  : ((D = []), (E.namespace = "")),
                (E.type = B),
                (E.guid = r.guid);
              var l = s[B],
              ...
              l ||
                ((l = s[B] = []),
                (A.setup && !1 !== A.setup.call(n, o, D, C)) ||
                  (n.addEventListener
                    ? n.addEventListener(B, C, !1)
                    : n.attachEvent && n.attachEvent("on" + B, C))),
                A.add &&
                  (A.add.call(n, E),
                  E.handler.guid || (E.handler.guid = r.guid)),
                l.push(E),
                (p.event.global[B] = !0);
            }
            n = null;
          ...
          if (3 !== e.nodeType && 8 !== e.nodeType) {
            ...
            if (u && l)
              if (
                ...
                for (r in ((t = t || ""), l)) p.event.remove(e, r + t);
              else {
                for (t = t.split(" "); (r = t[D++]); )
                  if (
                    ((s = r),
                    ...
                    if (n) {
                      for (
                        s = p.event.special[r] || {}, A = i || 0;
                        A < C.length &&
                        ((B = C[A]),
                        n.guid !== B.guid ||
                          ((o || E.test(B.namespace)) &&
                            (null == i && C.splice(A--, 1),
                            s.remove && s.remove.call(e, B)),
                          null == i));
                        A++
                      );
                      (0 === C.length || (null != i && 1 === C.length)) &&
                        ((s.teardown && !1 !== s.teardown.call(e, a)) ||
                          J(e, r, u.handle),
                        delete l[r]);
                    } else
                      for (var A = 0; A < C.length; A++)
                        (B = C[A]),
                          (o || E.test(B.namespace)) &&
                            (p.event.remove(e, s, B.handler, A),
                            C.splice(A--, 1));
                p.isEmptyObject(l) &&
                  ((t = u.handle) && (t.elem = null),
                  delete u.events,
                  delete u.handle,
                  p.isEmptyObject(u) && p.removeData(e));
              }
          }
        },
        trigger: function (e, i, r, o) {
            ...
            if (
              ((e =
                "object" === n(e)
                  ? e[P]
                    ? e
                    : p.extend(p.Event(a), e)
                  : p.Event(a)),
              a.indexOf("!") >= 0 &&
                ((e.type = a = a.slice(0, -1)), (e.exclusive = !0)),
              r ||
                (e.stopPropagation(),
                p.event.global[a] &&
                  p.each(p.cache, function () {
                    this.events &&
                      this.events[a] &&
                      p.event.trigger(e, i, this.handle.elem);
                  })),
              !r || 3 === r.nodeType || 8 === r.nodeType)
            )
              return t;
          ...
          try {
            (r && r.nodeName && p.noData[r.nodeName.toLowerCase()]) ||
              (r["on" + a] &&
                !1 === r["on" + a].apply(r, i) &&
                (e.result = !1));
          } catch (e) {}
          if (!e.isPropagationStopped() && o) p.event.trigger(e, i, o, !0);
            ...
            o = e.target;
            var E,
              s = p.nodeName(o, "a") && "click" === a,
              C = p.event.special[a] || {};
            if (
              !(
                (C._default && !1 !== C._default.call(r, e)) ||
                s ||
                (o && o.nodeName && p.noData[o.nodeName.toLowerCase()])
              )
            ) {
              try {
                o[a] &&
                  ((E = o["on" + a]) && (o["on" + a] = null),
                  (p.event.triggered = !0),
                  o[a]());
              } catch (e) {}
              E && (o["on" + a] = E), (p.event.triggered = !1);
            }
          }
        },
        handle: function (n) {
          var i, r, o, a;
          if (
            (((n = arguments[0] = p.event.fix(n || e.event)).currentTarget =
              this),
            ...
            for (var E = (r = r.slice(0)).length; a < E; a++) {
              var s = r[a];
              if (
                (i || o.test(s.namespace)) &&
                ((n.handler = s.handler),
                (n.data = s.data),
                (n.handleObj = s),
                (s = s.handler.apply(this, arguments)) !== t &&
                  ((n.result = s),
                  !1 === s && (n.preventDefault(), n.stopPropagation())),
        ...
        fix: function (e) {
          ...
          for (var i, r = this.props.length; r; )
            e[(i = this.props[--r])] = n[i];
          return (
            e.target || (e.target = e.srcElement || v),
        ...
        proxy: p.proxy,
        special: {
          ready: { setup: p.bindReady, teardown: p.noop },
          live: {
            add: function (e) {
              p.event.add(this, e.origType, p.extend({}, e, { handler: B }));
            },
            remove: function (e) {
              var t = !0,
      ...
      if (
        ...
        var K,
          ...
          te = function (e, n) {
            ...
            if (
              $.test(o.nodeName) &&
              !o.readOnly &&
              ((i = p.data(o, "_change_data")),
              (r = ee(o)),
              ("focusout" === e.type && "radio" === o.type) ||
                p.data(o, "_change_data", r),
              i !== t && r !== i && (null != i || r))
            )
              return (e.type = "change"), p.event.trigger(e, n, o);
          };
        (p.event.special.change = {
          ...
          teardown: function () {
            return (
              p.event.remove(this, ".specialChange"), $.test(this.nodeName)
            );
          },
        }),
      ...
      v.addEventListener &&
        p.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
          function n(e) {
            return (
              ((e = p.event.fix(e)).type = t), p.event.handle.call(this, e)
            );
          }
          p.event.special[t] = {
            setup: function () {
        ...
        p.each(["bind", "one"], function (e, i) {
          p.fn[i] = function (e, r, o) {
            ...
            var E =
              "one" === i
                ? p.proxy(o, function (e) {
                    return p(this).unbind(e, E), o.apply(this, arguments);
                  })
                : o;
            if ("unload" === e && "one" !== i) this.one(e, r, o);
            else {
              a = 0;
              for (var s = this.length; a < s; a++)
                p.event.add(this[a], e, E, r);
            }
            return this;
          };
        }),
        p.fn.extend({
          unbind: function (e, t) {
            if ("object" !== n(e) || e.preventDefault) {
              r = 0;
              for (var i = this.length; r < i; r++)
                p.event.remove(this[r], e, t);
          ...
          toggle: function (e) {
            ...
            return this.click(
              p.proxy(e, function (i) {
                var r = (p.data(this, "lastToggle" + e.guid) || 0) % n;
                return (
                  p.data(this, "lastToggle" + e.guid, r + 1),
                  i.preventDefault(),
      ...
      p.each(["live", "die"], function (e, n) {
        p.fn[n] = function (e, i, r, o) {
          ...
          for (
            p.isFunction(i) && ((r = i), (i = t)), e = (e || "").split(" ");
            null != (a = e[C++]);
            ...
            (E = ""),
              ...
              "hover" === a
                ? e.push("mouseenter" + E, "mouseleave" + E)
                : ((s = a),
                  "focus" === a || "blur" === a
                    ? (e.push(ne[a] + E), (a += E))
                    : (a = (ne[a] || a) + E),
        ...
        (function () {
          function e(t) {
            for (var n, i = "", r = 0; t[r]; r++)
              3 === (n = t[r]).nodeType || 4 === n.nodeType
                ? (i += n.nodeValue)
                : 8 !== n.nodeType && (i += e(n.childNodes));
            return i;
          }
          ...
          var C = function (e, t, n, i) {
            ...
            for (
              var E, s, u, l, A = [], p = !0, f = d(t), m = e;
              null !== (r.exec(""), (E = r.exec(m)));

            )
              if (((m = E[3]), A.push(E[1]), E[2])) {
                l = E[3];
                break;
              }
            if (A.length > 1 && D.exec(e))
              if (2 === A.length && B.relative[A[0]]) s = h(A[0] + A[1], t);
              else
                for (s = B.relative[A[0]] ? [t] : C(A.shift(), t); A.length; )
                  (e = A.shift()),
              ...
              (!i &&
                ...
                !f &&
                B.match.ID.test(A[0]) &&
                !B.match.ID.test(A[A.length - 1]) &&
                (t = (E = C.find(A.shift(), t, f)).expr
                  ? C.filter(E.expr, E.set)[0]
                  : E.set[0]),
              t)
            )
              for (
                s = (E = i
                  ...
                  ? C.filter(E.expr, E.set)
                  : E.set,
                  A.length > 0 ? (u = c(s)) : (p = !1);
                A.length;
            ...
            if (
              ...
              if (p)
                if (t && 1 === t.nodeType)
                  for (e = 0; null != u[e]; e++)
                    u[e] &&
                      (!0 === u[e] || (1 === u[e].nodeType && F(t, u[e]))) &&
                      n.push(s[e]);
                else
                  for (e = 0; null != u[e]; e++)
                    u[e] && 1 === u[e].nodeType && n.push(s[e]);
              else n.push.apply(n, u);
            else c(u, n);
            return l && (C(l, o, n, i), C.uniqueSort(n)), n;
          };
          (C.uniqueSort = function (e) {
            ...
            (C.find = function (e, t, n) {
              var i, r;
              if (!e) return [];
              for (var o = 0, a = B.order.length; o < a; o++) {
                var E = B.order[o];
              ...
              return (
                i || (i = t.getElementsByTagName("*")), { set: i, expr: e }
              );
            }),
            (C.filter = function (e, n, i, r) {
              for (
                var o, a, E = e, s = [], D = n, u = n && n[0] && d(n[0]);
                e && n.length;

              ) {
                for (var l in B.filter)
                  if (null != (o = B.leftMatch[l].exec(e)) && o[2]) {
                    var A,
                      c,
                      F = B.filter[l];
                    if (
                      ...
                      if ((D === s && (s = []), B.preFilter[l]))
                        if ((o = B.preFilter[l](o, D, i, s, r, u))) {
                          if (!0 === o) continue;
                        } else a = A = !0;
                      if (o)
                        for (var h = 0; null != (c = D[h]); h++)
                          if (c) {
                            var p = r ^ !!(A = F(c, o, h, D));
                            i && null != A
                              ? p
                      ...
                      if (A !== t) {
                        if ((i || (D = s), (e = e.replace(B.match[l], "")), !a))
                          return [];
                        break;
                      }
                    }
          ...
          var B = (C.selectors = {
              ...
              relative: {
                "+": function (e, t) {
                  ...
                  for (var r, o = e.length; i < o; i++)
                    if ((r = e[i])) {
                      for (; (r = r.previousSibling) && 1 !== r.nodeType; );
                      e[i] =
                        n || (r && r.nodeName.toLowerCase() === t)
                          ? r || !1
                          : r === t;
                    }
                  n && C.filter(t, e, !0);
                ...
                ">": function (e, t) {
                  ...
                  if (n && !/\W/.test(t)) {
                    ...
                    for (var i = 0, r = e.length; i < r; i++) {
                      ...
                      o &&
                        ((n = o.parentNode),
                        (e[i] = n.nodeName.toLowerCase() === t && n));
                    }
                  } else {
                    for (i = 0, r = e.length; i < r; i++)
                      (o = e[i]) &&
                        (e[i] = n ? o.parentNode : o.parentNode === t);
                    n && C.filter(t, e, !0);
                  }
                },
                "": function (e, t, r) {
                ...
                NAME: function (e, t) {
                  if (void 0 !== t.getElementsByName) {
                    for (
                      var n = [],
                        i = 0,
                        r = (t = t.getElementsByName(e[1])).length;
                      i < r;
                      i++
                    )
                      t[i].getAttribute("name") === e[1] && n.push(t[i]);
                ...
                PSEUDO: function (e, t, n, i, o) {
                  if ("not" === e[1]) {
                    if (!((r.exec(e[3]) || "").length > 1 || /^\w/.test(e[3])))
                      return (
                        (e = C.filter(e[3], t, n, !0 ^ o)),
                        n || i.push.apply(i, e),
                        !1
                      );
                    e[3] = C(e[3], null, null, t);
                  } else if (B.match.POS.test(e[0]) || B.match.CHILD.test(e[0]))
                    return !0;
                  return e;
                },
                POS: function (e) {
              ...
              filter: {
                PSEUDO: function (t, n, i, r) {
                  ...
                  if ("contains" === o)
                    return (
                      (t.textContent || t.innerText || e([t]) || "").indexOf(
                        n[3]
                      ) >= 0
                    );
                  if ("not" === o) {
                    for (i = 0, r = (n = n[3]).length; i < r; i++)
                      if (n[i] === t) return !1;
                    return !0;
                  }
            ...
            D = B.match.POS;
          for (var u in B.match)
            (B.match[u] = new RegExp(
              B.match[u].source + /(?![^\[]*\])(?![^\(]*\))/.source
            )),
              (B.leftMatch[u] = new RegExp(
                /(^(?:.|\r|\n)*?)/.source +
                  B.match[u].source.replace(/\\(\d+)/g, function (e, t) {
                    return "\\" + (t - 0 + 1);
                  })
              ));
          var l,
          ...
          v.documentElement.compareDocumentPosition
            ? (l = function (e, t) {
                return e.compareDocumentPosition && t.compareDocumentPosition
                  ? (0 ===
                      (e =
                        4 & e.compareDocumentPosition(t)
                          ...
                          : 1) && (E = !0),
                    e)
                  : (e == t && (E = !0), e.compareDocumentPosition ? -1 : 1);
              })
            : "sourceIndex" in v.documentElement
            ? (l = function (e, t) {
                return e.sourceIndex && t.sourceIndex
                  ? (0 === (e = e.sourceIndex - t.sourceIndex) && (E = !0), e)
                  : (e == t && (E = !0), e.sourceIndex ? -1 : 1);
              })
            : v.createRange &&
              (l = function (e, t) {
                if (!e.ownerDocument || !t.ownerDocument)
                  return e == t && (E = !0), e.ownerDocument ? -1 : 1;
                ...
                return (
                  ...
                  i.setStart(t, 0),
                  i.setEnd(t, 0),
                  0 === (e = n.compareBoundaryPoints(Range.START_TO_END, i)) &&
                    (E = !0),
                  e
                );
              }),
            (function () {
              ...
              i.insertBefore(e, i.firstChild),
                v.getElementById(n) &&
                  ((B.find.ID = function (e, n, i) {
                    if (void 0 !== n.getElementById && !i)
                      return (n = n.getElementById(e[1]))
                        ? n.id === e[1] ||
            ...
            A.firstChild &&
              void 0 !== A.firstChild.getAttribute &&
              "#" !== A.firstChild.getAttribute("href") &&
              (B.attrHandle.href = function (e) {
          ...
          var F = v.compareDocumentPosition
            ...
            h = function (e, t) {
              var n,
                i = [],
                r = "";
              for (t = t.nodeType ? [t] : t; (n = B.match.PSEUDO.exec(e)); )
                (r += n[0]), (e = e.replace(B.match.PSEUDO, ""));
              (e = B.relative[e] ? e + "*" : e), (n = 0);
      ...
      p.fn.extend({
        find: function (e) {
          for (
            ...
            if (((n = t.length), p.find(e, this[i], t), i > 0))
        ...
        closest: function (e, t) {
          if (p.isArray(e)) {
            ...
            if (o && e.length) {
              n = 0;
              for (var E = e.length; n < E; n++)
                a[(i = e[n])] ||
                  (a[i] = p.expr.match.POS.test(i)
                    ? p(i, t || this.context)
                    : i);
              for (; o && o.ownerDocument && o !== t; ) {
                for (i in a)
                  ((n = a[i]).jquery ? n.index(o) > -1 : p(o).is(n)) &&
                    (r.push({ selector: i, elem: o }), delete a[i]);
                o = o.parentNode;
              }
            }
            return r;
        ...
        index: function (e) {
          return e && "string" != typeof e
            ...
            : p.inArray(this[0], e ? p(e) : this.parent().children());
        },
        add: function (e, t) {
          return (
            (e =
              "string" == typeof e ? p(e, t || this.context) : p.makeArray(e)),
        ...
        p.extend({
          ...
          dir: function (e, n, i) {
            ...
            for (
              ...
              e &&
              9 !== e.nodeType &&
              (i === t || 1 !== e.nodeType || !p(e).is(i));

            )
              1 === e.nodeType && r.push(e), (e = e[n]);
            return r;
          },
          nth: function (e, t, n) {
            t = t || 1;
      ...
      (de.optgroup = de.option),
        ...
        p.fn.extend({
          ...
          remove: function (e, t) {
            for (var n, i = 0; null != (n = this[i]); i++)
              (e && !p.filter(e, [n]).length) ||
                (t ||
                  1 !== n.nodeType ||
                  (p.cleanData(n.getElementsByTagName("*")), p.cleanData([n])),
          ...
          empty: function () {
            for (var e, t = 0; null != (e = this[t]); t++)
              for (
                1 === e.nodeType && p.cleanData(e.getElementsByTagName("*"));
                e.firstChild;
          ...
          clone: function (e) {
            var t = this.map(function () {
              ...
              return (
                e ||
                  ((e = t.createElement("div")).appendChild(this.cloneNode(!0)),
                  (e = e.innerHTML)),
                p.clean(
                  [
                    e
            ...
            return !0 === e && (l(this, t), l(this.find("*"), t.find("*"))), t;
          },
          html: function (e) {
            if (e === t)
              return this[0] && 1 === this[0].nodeType
                ? this[0].innerHTML.replace(Ee, "")
                : null;
            if (
              "string" != typeof e ||
              Ae.test(e) ||
              (!p.support.leadingWhitespace && se.test(e)) ||
              de[(De.exec(e) || ["", ""])[1].toLowerCase()]
            )
              p.isFunction(e)
                ? this.each(function (t) {
                    var n = p(this),
              ...
              try {
                for (var n = 0, i = this.length; n < i; n++)
                  1 === this[n].nodeType &&
                    (p.cleanData(this[n].getElementsByTagName("*")),
                    (this[n].innerHTML = e));
              } catch (t) {
                this.empty().append(e);
              }
            ...
            if (this[0]) {
              if (
                ...
                (E =
                  1 ===
                  (s = (a =
                    p.support.parentNode &&
                    a &&
                    11 === a.nodeType &&
                    a.childNodes.length === this.length
                      ? { fragment: a }
                      : A(e, this, B)).fragment).childNodes.length
                    ? (s = s.firstChild)
                    : s.firstChild))
              ) {
                n = n && p.nodeName(E, "tr");
                for (var D = 0, u = this.length; D < u; D++)
                  i.call(
                    n ? o(this[D]) : this[D],
                    D > 0 || a.cacheable || this.length > 1
                      ? s.cloneNode(!0)
                      : s
                  );
              }
          ...
          function (e, t) {
            p.fn[e] = function (n) {
              ...
              for (var o = n.length; r < o; r++) {
                ...
                p.fn[t].apply(p(n[r]), a), (i = i.concat(a));
              }
        ...
        p.extend({
          clean: function (e, t, n, i) {
            void 0 === (t = t || v).createElement &&
              (t = t.ownerDocument || (t[0] && t[0].ownerDocument) || v);
            for (var r, o = [], a = 0; null != (r = e[a]); a++)
                            ...
                            (E =
                              "table" !== E || C
                                ? "<table>" !== s[1] || C
                                  ? []
                                  : B.childNodes
                                : B.firstChild && B.firstChild.childNodes)
                              .length - 1;
                        s >= 0;
                        --s
                      )
                        p.nodeName(E[s], "tbody") &&
                          !E[s].childNodes.length &&
                          E[s].parentNode.removeChild(E[s]);
                    !p.support.leadingWhitespace &&
                      se.test(r) &&
                      B.insertBefore(
                        t.createTextNode(se.exec(r)[0]),
                        B.firstChild
                      ),
                      (r = B.childNodes);
                  }
            ...
            if (n)
              for (a = 0; o[a]; a++)
                !i ||
                !p.nodeName(o[a], "script") ||
                (o[a].type && "text/javascript" !== o[a].type.toLowerCase())
                  ? (1 === o[a].nodeType &&
                      o.splice.apply(
                        o,
                        [a + 1, 0].concat(
                          p.makeArray(o[a].getElementsByTagName("script"))
                        )
                      ),
                    n.appendChild(o[a]))
                  : i.push(
              ...
              if ((n = i[p.expando])) {
                if ((t = r[n]).events)
                  for (var s in t.events)
                    o[s] ? p.event.remove(i, s) : J(i, s, t.handle);
                a
                  ? delete i[p.expando]
                  : i.removeAttribute && i.removeAttribute(p.expando),
                  delete r[n];
              }
          },
        });
      ...
      (p.fn.css = function (e, n) {
        return o(this, e, n, !0, function (e, n, i) {
        ...
        p.extend({
          style: function (e, n, i) {
            ...
            var r = e.style || e,
              o = i !== t;
            return p.support.opacity || "opacity" !== n
              ? (me.test(n) && (n = je),
                (n = n.replace(ve, Te)),
                o && (r[n] = i),
                r[n])
              : (o &&
                  ...
                  (n =
                    parseInt(i, 10) + "" == "NaN"
                      ? ""
                      : "alpha(opacity=" + 100 * i + ")"),
                  (e = r.filter || p.curCSS(e, "filter") || ""),
                  (r.filter = pe.test(e) ? e.replace(pe, n) : n)),
                r.filter && r.filter.indexOf("opacity=") >= 0
                  ? parseFloat(fe.exec(r.filter)[1]) / 100 + ""
                  : "");
          },
                  ...
                  (r = "width" === t ? e.offsetWidth : e.offsetHeight),
                    "border" !== i &&
                      p.each(a, function () {
                        i ||
                          (r -=
                            parseFloat(p.curCSS(e, "padding" + this, !0)) || 0),
                          "margin" === i
                            ? (r +=
                                parseFloat(p.curCSS(e, "margin" + this, !0)) ||
                                0)
                            : (r -=
                                parseFloat(
                                  p.curCSS(e, "border" + this + "Width", !0)
                                ) || 0);
                      });
                },
                a = "width" === t ? we : xe;
              return (
                0 !== e.offsetWidth ? o() : p.swap(e, be, o),
          ...
          curCSS: function (e, t, n) {
            var i,
              r = e.style;
            if (!p.support.opacity && "opacity" === t && e.currentStyle)
              return "" ===
                (i = fe.test(e.currentStyle.filter || "")
            ...
            if ((me.test(t) && (t = je), !n && r && r[t])) i = r[t];
              ...
              if (
                (me.test(t) && (t = "float"),
                (t = t.replace(ge, "-$1").toLowerCase()),
                !(r = e.ownerDocument.defaultView))
              )
                return null;
              (e = r.getComputedStyle(e, null)) && (i = e.getPropertyValue(t)),
                "opacity" === t && "" === i && (i = "1");
            } else if (
              e.currentStyle &&
              ((n = t.replace(ve, Te)),
              (i = e.currentStyle[t] || e.currentStyle[n]),
              !_e.test(i) && ye.test(i))
            ) {
              t = r.left;
        ...
        p.expr &&
          ...
          ((p.expr.filters.hidden = function (e) {
            ...
            return (
              (0 === t && 0 === n && !i) ||
              (!(t > 0 && n > 0 && !i) && "none" === p.curCSS(e, "display"))
            );
          }),
      ...
      p.fn.extend({
          ...
          (r = "GET"),
            t &&
              (p.isFunction(t)
                ? ((i = t), (t = null))
                : "object" === n(t) &&
                  ((t = p.param(t, p.ajaxSettings.traditional)), (r = "POST")));
          var a = this;
          return (
            p.ajax({
              url: e,
              ...
              complete: function (e, t) {
                ("success" !== t && "notmodified" !== t) ||
                  a.html(
                    o
                      ? p("<div />")
                          .append(e.responseText.replace(Se, ""))
                          .find(o)
                      : e.responseText
                  ),
          ...
          return this.map(function () {
            ...
            .filter(function () {
              return (
                this.name &&
                !this.disabled &&
                (this.checked || Ne.test(this.nodeName) || Oe.test(this.type))
              );
            })
            .map(function (e, t) {
              return null == (e = p(this).val())
                ? null
                : p.isArray(e)
                ? p.map(e, function (e) {
        ...
        p.extend({
          get: function (e, t, n, i) {
            return (
              p.isFunction(t) && ((i = i || n), (n = t), (t = null)),
              p.ajax({ type: "GET", url: e, data: t, success: n, dataType: i })
            );
          },
          ...
          post: function (e, t, n, i) {
            return (
              p.isFunction(t) && ((i = i || n), (n = t), (t = {})),
              p.ajax({ type: "POST", url: e, data: t, success: n, dataType: i })
            );
          },
          ...
          ajaxSettings: {
            ...
            xhr:
              !e.XMLHttpRequest ||
              ("file:" === e.location.protocol && e.ActiveXObject)
                ? function () {
                    try {
          ...
          ajax: function (n) {
            ...
            if (
              (B.data &&
                ...
                (B.data = p.param(B.data, B.traditional)),
              "jsonp" === B.dataType &&
                ("GET" === u
                  ? Pe.test(B.url) ||
                    (B.url +=
                ...
                (B.dataType = "json")),
              "json" === B.dataType &&
                ((B.data && Pe.test(B.data)) || Pe.test(B.url)) &&
                ((E = B.jsonpCallback || "jsonp" + Ie++),
                B.data && (B.data = (B.data + "").replace(Pe, "=" + E + "$1")),
                (B.url = B.url.replace(Pe, "=" + E + "$1")),
                (B.dataType = "script"),
                (e[E] =
                  e[E] ||
                  function (n) {
              ...
              "script" === B.dataType && null === B.cache && (B.cache = !1),
              !1 === B.cache && "GET" === u)
            ) {
              var l = a(),
              ...
              B.url =
                A +
                (A === B.url ? (Me.test(B.url) ? "&" : "?") + "_=" + l : "");
            }
            if (
              (B.data &&
                "GET" === u &&
                (B.url += (Me.test(B.url) ? "&" : "?") + B.data),
              B.global && !p.active++ && p.event.trigger("ajaxStart"),
              (l =
                (l = Le.exec(B.url)) &&
                ((l[1] && l[1] !== location.protocol) ||
                  l[2] !== location.host)),
              "script" === B.dataType && "GET" === u && l)
            ) {
              var c = v.getElementsByTagName("head")[0] || v.documentElement,
                F = v.createElement("script");
              if (
                ((F.src = B.url),
                B.scriptCharset && (F.charset = B.scriptCharset),
                !E)
              ) {
                var d = !1;
              ...
              return c.insertBefore(F, c.firstChild), t;
            }
            var h = !1,
              f = B.xhr();
            if (f) {
              B.username
                ? f.open(u, B.url, B.async, B.username, B.password)
                : f.open(u, B.url, B.async);
              try {
                (B.data || (n && n.contentType)) &&
                  f.setRequestHeader("Content-Type", B.contentType),
                  B.ifModified &&
                    (p.lastModified[B.url] &&
                      f.setRequestHeader(
                        "If-Modified-Since",
                        p.lastModified[B.url]
                      ),
                    p.etag[B.url] &&
                      f.setRequestHeader("If-None-Match", p.etag[B.url])),
                  l || f.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                  f.setRequestHeader(
                    "Accept",
                    B.dataType && B.accepts[B.dataType]
                      ? B.accepts[B.dataType] + ", */*"
                      : B.accepts._default
                  );
              } catch (e) {}
              if (B.beforeSend && !1 === B.beforeSend.call(D, f, B))
                return (
                  B.global && !--p.active && p.event.trigger("ajaxStop"),
                  f.abort(),
                  !1
              ...
              var m = (f.onreadystatechange = function (e) {
                if (f && 0 !== f.readyState && "abort" !== e) {
                  if (!h && f && (4 === f.readyState || "timeout" === e)) {
                    ...
                    if (
                      ((h = !0),
                      (f.onreadystatechange = p.noop),
                      "success" ===
                        (s =
                          "timeout" === e
                            ? "timeout"
                            : p.httpSuccess(f)
                            ? B.ifModified && p.httpNotModified(f, B.url)
                              ? "notmodified"
                              : "success"
                            : "error"))
                    )
                    ...
                    "success" === s || "notmodified" === s
                      ? E || i()
                      : p.handleError(B, f, s, t),
                      r(),
                      "timeout" === e && f.abort(),
                      B.async && (f = null);
                  }
              ...
              try {
                f.send(
                  "POST" === u || "PUT" === u || "DELETE" === u ? B.data : null
                );
              } catch (e) {
                p.handleError(B, f, null, e), r();
              }
              return B.async || m(), f;
            }
          },
          handleError: function (e, t, n, i) {
            e.error && e.error.call(e.context || e, t, n, i),
              e.global &&
                (e.context ? p(e.context) : p.event).trigger("ajaxError", [
                  t,
                  e,
                  i,
                ]);
            ...
            return (
              ...
              "string" == typeof e &&
                ("json" === t || (!t && i.indexOf("json") >= 0)
                  ? (e = p.parseJSON(e))
                  : ("script" === t || (!t && i.indexOf("javascript") >= 0)) &&
                    p.globalEval(e)),
              e
            );
          },
          param: function (e, i) {
            ...
            var a = [];
            if (
              (i === t && (i = p.ajaxSettings.traditional),
              p.isArray(e) || e.jquery)
            )
              p.each(e, function () {
      ...
      p.fn.extend({
        show: function (e, t) {
          ...
          for (e = 0, t = this.length; e < t; e++)
            this[e].style.display = p.data(this[e], "olddisplay") || "";
          return this;
        },
        hide: function (e, t) {
          ...
          for (e = 0, t = this.length; e < t; e++) {
            ...
            !n &&
              "none" !== n &&
              p.data(this[e], "olddisplay", p.css(this[e], "display"));
          }
          for (e = 0, t = this.length; e < t; e++)
          ...
          return p.isEmptyObject(e)
            ...
            : this[!1 === r.queue ? "each" : "queue"](function () {
                ...
                for (t in e) {
                  ...
                  if (
                    (t !== a && ((e[a] = e[t]), delete e[t], (t = a)),
                    ("hide" === e[t] && i) || ("show" === e[t] && !i))
                  )
                    return n.complete.call(this);
                  ("height" !== t && "width" !== t) ||
                    !this.style ||
                    ((n.display = p.css(this, "display")),
                ...
                return (
                  ...
                  (n.curAnim = p.extend({}, e)),
                  p.each(e, function (t, r) {
                    var a = new p.fx(o, n, t);
                    if (We.test(r))
                      a["toggle" === r ? (i ? "show" : "hide") : r](e);
                    else {
                      var E = He.exec(r),
                        s = a.cur(!0) || 0;
                      if (E) {
          ...
          speed: function (e, t, i) {
            ...
            return (
              (r.duration = p.fx.off
                ...
                ? r.duration
                : p.fx.speeds[r.duration] || p.fx.speeds._default),
              (r.old = r.complete),
              (r.complete = function () {
        ...
        (p.fx.prototype = {
          ...
          cur: function (e) {
            return null == this.elem[this.prop] ||
              ...
              ? (e = parseFloat(p.css(this.elem, this.prop, e))) && e > -1e4
                ? e
                : parseFloat(p.curCSS(this.elem, this.prop)) || 0
              : this.elem[this.prop];
          },
          ...
          step: function (e) {
              ...
              if (n) {
                if (
                  (null != this.options.display &&
                    ...
                    (e = p.data(this.elem, "olddisplay")),
                    (this.elem.style.display = e || this.options.display),
                    "none" === p.css(this.elem, "display") &&
                      (this.elem.style.display = "block")),
                  this.options.hide && p(this.elem).hide(),
                  this.options.hide || this.options.show)
                )
                  for (var r in this.options.curAnim)
                    p.style(this.elem, r, this.options.orig[r]);
            ...
            return (
              ...
              (e =
                this.options.easing || (p.easing.swing ? "swing" : "linear")),
              (this.pos = p.easing[
        ...
        p.extend(p.fx, {
          tick: function () {
            for (var e = p.timers, t = 0; t < e.length; t++)
              e[t]() || e.splice(t--, 1);
            e.length || p.fx.stop();
          },
          stop: function () {
          ...
          "getBoundingClientRect" in v.documentElement
            ...
            : function (e) {
                ...
                r = (o = o.defaultView)
                  ...
                  : t.currentStyle;
                for (
                  var s = t.offsetTop, C = t.offsetLeft;
                  (t = t.parentNode) &&
                  t !== E &&
                  t !== a &&
                  (!p.offset.supportsFixedPosition || "fixed" !== r.position);
                  ...
                  (n = o ? o.getComputedStyle(t, null) : t.currentStyle),
                    ...
                    t === i &&
                      ((s += t.offsetTop),
                      (C += t.offsetLeft),
                      !p.offset.doesNotAddBorder ||
                        (p.offset.doesAddBorderForTableAndCells &&
                          /^t(able|d|h)$/i.test(t.nodeName)) ||
                        ((s += parseFloat(n.borderTopWidth) || 0),
                        (C += parseFloat(n.borderLeftWidth) || 0)),
                      (r = i),
                      (i = t.offsetParent)),
                    p.offset.subtractsBorderForOverflowNotVisible &&
                      "visible" !== n.overflow &&
                      ((s += parseFloat(n.borderTopWidth) || 0),
                      (C += parseFloat(n.borderLeftWidth) || 0)),
                    (r = n);
                return (
                  ("relative" !== r.position && "static" !== r.position) ||
                    ((s += E.offsetTop), (C += E.offsetLeft)),
                  p.offset.supportsFixedPosition &&
                    "fixed" === r.position &&
                    ((s += Math.max(a.scrollTop, E.scrollTop)),
                    (C += Math.max(a.scrollLeft, E.scrollLeft))),
                  { top: s, left: C }
                );
              }),
        (p.offset = {
          ...
          bodyOffset: function (e) {
            ...
            return (
              p.offset.initialize(),
              p.offset.doesNotIncludeMarginInBodyOffset &&
                ((t += parseFloat(p.curCSS(e, "marginTop", !0)) || 0),
                (n += parseFloat(p.curCSS(e, "marginLeft", !0)) || 0)),
              { top: t, left: n }
            );
          },
          setOffset: function (e, t, n) {
            /static/.test(p.curCSS(e, "position")) &&
              (e.style.position = "relative");
            var i = p(e),
              r = i.offset(),
            ...
            p.isFunction(t) && (t = t.call(e, n, r)),
              (n = { top: t.top - r.top + o, left: t.left - r.left + a }),
            ...
            return o
              ? n !== t
                ...
                ? "pageXOffset" in r
                  ...
                  : (p.support.boxModel && r.document.documentElement[i]) ||
                    r.document.body[i]
                : o[i]
              : null;
          };
        ...
        p.each(["Height", "Width"], function (e, n) {
          ...
          (p.fn["inner" + n] = function () {
            ...
            (p.fn["outer" + n] = function (e) {
              return this[0]
                ? p.css(this[0], i, !1, e ? "margin" : "border")
                : null;
            }),
            (p.fn[i] = function (e) {
              var r = this[0];
              return r
                ? p.isFunction(e)
                  ...
                  : "scrollTo" in r && r.document
                  ? ("CSS1Compat" === r.document.compatMode &&
                      r.document.documentElement["client" + n]) ||
                    r.document.body["client" + n]
                  : 9 === r.nodeType
                  ? Math.max(
                  ...
                  : e === t
                  ? p.css(r, i)
                  : this.css(i, "string" == typeof e ? e : e + "px")
                : null == e
                ? null
                : this;
            });
    ...
    !(function () {
      ...
      (e.prototype = {
        ...
        (t.prototype = {
          ...
          setupPositionAdjustPattern: function () {
            for (
              var e = l.getPatternPosition(this.typeNumber), t = 0;
              t < e.length;
              t++
            )
          ...
          setupTypeNumber: function (e) {
            for (
              var t = l.getBCHTypeNumber(this.typeNumber), n = 0;
              n < 18;
              n++
            ) {
              var i = !e && 1 == ((t >> n) & 1);
        ...
        (t.createData = function (e, n, i) {
          for (
            var r = d.getRSBlocks(e, n), o = new h(), a = 0;
            a < i.length;
            a++
          ) {
            var E = i[a];
          ...
          for (
            o.getLengthInBits() + 4 <= 8 * s && o.put(0, 4);
          ...
          for (
            ...
            !(
              ...
              (o.put(t.PAD0, 8), o.getLengthInBits() >= 8 * s)
            );
        ...
        (t.createBytes = function (e, t) {
          for (
            ...
            var s = t[E].dataCount,
              C = t[E].totalCount - s;
            (i = Math.max(i, s)), (r = Math.max(r, C)), (o[E] = new Array(s));
            for (var B = 0; B < o[E].length; B++)
              o[E][B] = 255 & e.buffer[B + n];
            n += s;
          ...
          for (B = 0; B < i; B++)
            for (E = 0; E < t.length; E++)
              B < o[E].length && (d[h++] = o[E][B]);
          for (B = 0; B < r; B++)
            for (E = 0; E < t.length; E++)
              B < a[E].length && (d[h++] = a[E][B]);
          return d;
        });
      for (
        var i = {
          ...
          l = {
            ...
            getBCHTypeInfo: function (e) {
              for (
                var t = e << 10;
                l.getBCHDigit(t) - l.getBCHDigit(l.G15) >= 0;
            ...
            getBCHTypeNumber: function (e) {
              for (
                var t = e << 12;
                l.getBCHDigit(t) - l.getBCHDigit(l.G18) >= 0;
            ...
            getErrorCorrectPolynomial: function (e) {
              for (var t = new F([1], 0), n = 0; n < e; n++)
                t = t.multiply(new F([1, A.gexp(n)], 0));
              return t;
            },
            ...
            getLostPoint: function (e) {
              for (var t = e.getModuleCount(), n = 0, i = 0; i < t; i++)
                for (var r = 0; r < t; r++) {
                  for (var o = 0, a = e.isDark(i, r), E = -1; E <= 1; E++)
                    if (!(i + E < 0 || t <= i + E))
                      for (var s = -1; s <= 1; s++)
                        r + s < 0 ||
                          t <= r + s ||
                          (0 == E && 0 == s) ||
                          (a == e.isDark(i + E, r + s) && o++);
                  o > 5 && (n += 3 + o - 5);
                }
              for (i = 0; i < t - 1; i++)
                for (r = 0; r < t - 1; r++) {
      ...
      (F.prototype = {
        ...
        (d.getRSBlocks = function (e, t) {
          ...
          for (var i = n.length / 3, r = [], o = 0; o < i; o++)
            for (
              var a = n[3 * o + 0], E = n[3 * o + 1], s = n[3 * o + 2], C = 0;
              C < a;
              C++
            )
              r.push(new d(E, s));
          ...
          return (
            (e.prototype.draw = function (e) {
              ...
              for (var a = 0; a < i; a++)
                for (var E = 0; E < i; E++)
                  if (e.isDark(a, E)) {
                    var s = r("use", { x: String(E), y: String(a) });
                    s.setAttributeNS(
                      "http://www.w3.org/1999/xlink",
                      "href",
                      "#template"
                      ...
                      for (var s = 0; s < i; s++)
                        a.push(
                          '<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' +
                            ...
                            o +
                            "px;background-color:" +
                            (e.isDark(E, s) ? t.colorDark : t.colorLight) +
                            ';"></td>'
                        );
                      a.push("</tr>");
                    }
            ...
            : (function () {
                ...
                function i(e, t) {
                  ...
                  !0 === n._bSupportDataURI && n._fSuccess
                    ? n._fSuccess.call(n)
                    : !1 === n._bSupportDataURI && n._fFail && n._fFail.call(n);
                }
                var r = function (e, t) {
                  (this._bIsPainted = !1),
                    (this._android = f()),
      ...
      (window.QRCode = n =
        ...
        (n.prototype.makeCode = function (e) {
          (this._oQRCode = new t(
            g(e, this._htOption.correctLevel),
  ...
  function (e, t, n) {
    ...
    function T(e, t, n) {
      window.document.cookie =
        e + "=" + escape(t) + (null == n ? "" : "; expires=" + n.toGMTString());
    }
    function I(e) {
      var t = e + "=";
      if (window.document.cookie.length > 0) {
        ...
        if (-1 != n) {
          ...
          return (
            -1 == i && (i = window.document.cookie.length),
    ...
    function S(e) {
      return (e = (e = (e = (e = (e = (e = e.replace(/&lt/g, "<")).replace(
        /&gt/g,
        ">"
      )).replace(/&amp/g, "&")).replace(/&quot/g, '"')).replace(
        /&apos/g,
        "'"
      )).replace(/<br>/g, "\n"));
    }
    function N(e, t, n, i, o, s, B) {
      ...
      if (((b = 0), "iPhone" == u || "iPad" == u || "iPod" == u)) r(e);
        ...
        if (
          ((3 != B && 4 != B) || (ne.thunderType = B),
          "boolean" != typeof o &&
            2 != (o = isNaN(o) ? void 0 : Number(o)) &&
            10 != o &&
            (o = void 0),
          (1 != o && 10 != o) || null == o
            ? (0 != o && 2 != o) || null == o || (ne.isOpenNew = !1)
            : (ne.isOpenNew = !0),
          x)
        )
          return v.load_pc_xunlei_success(e), ne.download(e, n, "", "");
        re(e, i);
      }
      return !1;
    }
    ...
    var O = function (e, t) {
      var n = A();
      "Firefox" == n || "Chrome" == n || "SB360" == n
        ? re(e, t)
        : "unknown" == n
        ? alert(
            unescape(
              "\u62b1\u6b49\uff0c\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u8fc5\u96f7\u4e13\u7528\u94fe\u4e0b\u8f7d\uff0c\u8bf7\u66f4\u6362\u522b\u7684\u6d4f\u89c8\u5668\u5982IE9\u518d\u8bd5"
            )
          )
        : N(e, 0, location.href, t, !1, "");
    };
    function P(e, t, n, s) {
      1;
      var C = "",
        ...
        l = c();
      "" == C &&
        ((null != (C = e.getAttribute(B)) && "" != C) ||
          (C = e.getAttribute("thunderHref")));
      location.href;
      ...
      if ((m.init(d), "iPhone" == l || "iPad" == l || "iPod" == l)) {
        ...
        o(d, function (e) {
          e && _(e, "9.0.0.0") >= 0
            ? (v.load_pc_xunlei_success(C),
              i({ thunderPid: d, url: C }, function () {
                O(C, d);
              }))
            : (delete m.thunderInstallPack,
              m.copyText(C),
              (m.fn = oe(C).split("?")[0].split("/").pop()),
              m.popup("not_install_on_win", C, !1, !1));
        });
      }
      return !1;
    }
      ...
      var o = (function () {
          ...
          try {
            if (navigator.userAgent.indexOf("MSIE") > 0)
              e = new ActiveXObject("ThunderAgent.Agent.1");
            else {
              if (!navigator.mimeTypes["application/x-thunder-XBrowserAgent"])
                return "";
              ...
              0 == r.status &&
                (function (e) {
                  j_xunlei_q.ajax({
                    ...
                    data: { checkcode: e.checkcode },
                    dataType: "jsonp",
                    timeout: 6e4,
                    success: function (e) {
                      if (0 == e.status) {
                        var t = 10;
                        j_xunlei_q(".thunder_m_tip .thunder_m_foot").fadeIn(
                          "normal"
                        ),
                          j_xunlei_q(
                            ".thunder_m_tip .thunder_m_already span"
                          ).html(
                            "\u8fc5\u96f7\u5df2\u5efa\u7acb\u4efb\u52a1\uff0c\u4e0b\u8f7d\u9875\u5728" +
                              t +
                              "\u79d2\u540e\u5173\u95ed"
                          ...
                          j_xunlei_q(
                            ".thunder_m_tip .thunder_m_already"
                          ).fadeIn("normal"),
                          t--,
                          (M = setInterval(function () {
                            if (t <= 0)
                              return (M = clearInterval(M)), q(), J(9), !1;
                            j_xunlei_q(
                              ".thunder_m_tip .thunder_m_already span"
                            ).html(
                              "\u8fc5\u96f7\u5df2\u5efa\u7acb\u4efb\u52a1\uff0c\u4e0b\u8f7d\u9875\u5728" +
    ...
    function H(e, t, n) {
      j_xunlei_q("#thunder_load_code_fail").show(),
        ...
        j_xunlei_q("#thunder_reload_rpcode_img")
          .unbind("click")
          .click(function () {
          ...
          try {
            0 == e.status
              ? (j_xunlei_q(".thunder_m_tip #thunder_m_note")
                  ...
                  .show(),
                j_xunlei_q("#thunder_m_phone")
                  .removeClass("thunder_m_on1")
                  .val(
                    "\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d"
                  ),
                J(5))
    ...
    function q() {
      (M = clearInterval(M)),
        document.getElementById("thunder_m_fdiv") &&
          (navigator.userAgent.indexOf("MSIE") > 0
            ? document.getElementById("thunder_m_fdiv").removeNode(!0)
            : document
                .getElementById("thunder_m_fdiv")
                .parentNode.removeChild(
                  document.getElementById("thunder_m_fdiv")
                )),
        document.getElementById("thunder_m_opac") &&
          (navigator.userAgent.indexOf("MSIE") > 0
            ? document.getElementById("thunder_m_opac").removeNode(!0)
            : document
                .getElementById("thunder_m_opac")
                .parentNode.removeChild(
                  document.getElementById("thunder_m_opac")
                ));
    }
    function z() {
      j_xunlei_q(".thunder_m_tip #thunder_m_valid").val(
        "\u8f93\u5165\u9a8c\u8bc1\u7801"
      ),
        j_xunlei_q(".thunder_m_tip .thunder_m_valid").show(),
        j_xunlei_q("#thunder_m_valid").removeClass("thunder_m_on1");
      var e = new Date();
      j_xunlei_q("#thunder_m_check_code").attr(
        "src",
        "http://verify2.xunlei.com/image?r=" + e.getTime()
      );
    }
    function J(e) {
      try {
        var t =
          "http://stat.download.xunlei.com:8080/?aid=1008&id=" +
          e +
          "&click=1&_t=" +
          new Date().getTime();
        new Image().src = t;
    ...
    function V(e, t) {
      !(function (e, t, n) {
        try {
          var i =
            "http://stat.download.xunlei.com:8080/?aid=" +
            e +
            "&id=" +
            t +
            "&f=" +
      ...
      if (null == t) {
        t =
          ...
          ((e = function () {
            ...
            e());
        var n = new Date();
        n.setTime(n.getTime() + 864e10), T(w, t, n);
      }
    }
    function K(e) {
      e.href = "JavaScript:;";
    ...
    var $ = function () {
      ...
      te = [];
    (te.WebThunderSetUpInfo = unescape(
      "%u6B64%u94FE%u63A5%u4E3A%u8FC5%u96F7%u4E13%u7528%u4E0B%u8F7D%u901A%u9053%uFF0C%u5FC5%u987B%u5B89%u88C5%u8FC5%u96F7%u624D%u80FD%u4E0B%u8F7D%uFF0C%u5B89%u88C5%u540E%u8BF7%u91CD%u65B0%u8FDB%u5165%u6B64%u9875%u8FDB%u884C%u4E0B%u8F7D%u3002%u70B9%u51FB%u786E%u5B9A%u5373%u523B%u5B89%u88C5%u8FC5%u96F77%uFF0C%u4F53%u9A8C%u6781%u901F%u4E0B%u8F7D%u7684%u4E50%u8DA3%uFF01"
    )),
      (te.Thunder5SetUpInfo = unescape(
        "%u6B64%u94FE%u63A5%u4E3A%u8FC5%u96F7%u4E13%u7528%u4E0B%u8F7D%u901A%u9053%uFF0C%u5FC5%u987B%u5B89%u88C5%u8FC5%u96F7%u624D%u80FD%u4E0B%u8F7D%uFF0C%u5B89%u88C5%u540E%u8BF7%u91CD%u65B0%u8FDB%u5165%u6B64%u9875%u8FDB%u884C%u4E0B%u8F7D%u3002%u70B9%u51FB%u786E%u5B9A%u5373%u523B%u5B89%u88C5%u8FC5%u96F77%uFF0C%u4F53%u9A8C%u6781%u901F%u4E0B%u8F7D%u7684%u4E50%u8DA3%uFF01"
      )),
      (te.Thunder9SetUpInfo = unescape(
        "%u6B64%u94FE%u63A5%u4E3A%u8FC5%u96F7%u4E13%u7528%u4E0B%u8F7D%u901A%u9053%uFF0C%u5FC5%u987B%u5B89%u88C5%u8FC5%u96F7%u624D%u80FD%u4E0B%u8F7D%uFF0C%u5B89%u88C5%u540E%u8BF7%u91CD%u65B0%u8FDB%u5165%u6B64%u9875%u8FDB%u884C%u4E0B%u8F7D%u3002%u70B9%u51FB%u786E%u5B9A%u5373%u523B%u5B89%u88C5%u8FC5%u96F79%uFF0C%u4F53%u9A8C%u6781%u901F%u4E0B%u8F7D%u7684%u4E50%u8DA3%uFF01"
      )),
      (te.AllSetUpInfo = unescape(
        "%u6B64%u94FE%u63A5%u4E3A%u8FC5%u96F7%u4E13%u7528%u4E0B%u8F7D%u901A%u9053%uFF0C%u5FC5%u987B%u5B89%u88C5%u8FC5%u96F7%u624D%u80FD%u4E0B%u8F7D%uFF0C%u5B89%u88C5%u540E%u8BF7%u91CD%u65B0%u8FDB%u5165%u6B64%u9875%u8FDB%u884C%u4E0B%u8F7D%u3002%u70B9%u51FB%u786E%u5B9A%u5373%u523B%u5B89%u88C5%u8FC5%u96F77%uFF0C%u4F53%u9A8C%u6781%u901F%u4E0B%u8F7D%u7684%u4E50%u8DA3%uFF01"
      )),
      (te.MethodUnSupported = unescape(
        "%u4E0D%u652F%u6301%u6B64%u65B9%u6CD5%uFF0C%u8BF7%u5B89%u88C5%u6700%u65B0%u7684%u8FC5%u96F7%u5BA2%u6237%u7AEF"
      )),
      (te.FFDenied = unescape(
        "%u6B64%u64CD%u4F5C%u88AB%u6D4F%u89C8%u5668%u62D2%u7EDD%uFF01%0A%u8BF7%u5728%u6D4F%u89C8%u5668%u5730%u5740%u680F%u8F93%u5165%u201Cabout%3Aconfig%u201D%u5E76%u56DE%u8F66%0A%u7136%u540E%u5C06%5Bsigned.applets.codebase_principal_support%5D%u8BBE%u7F6E%u4E3A%27true%27"
      )),
    ...
    var ne = {
      ...
      getInstance: function (e) {
        if (null == this.isOpenNew)
          try {
            this.isOpenNew = !0;
          } catch (e) {}
        if (null == this.mustUseSelected)
          try {
        ...
        if (this.judgeThunder())
          (this.thunderType = this.judgeThunder()), (this.mustUseSelected = !0);
        else if (!this.thunderType)
          try {
            switch (C) {
              case "coThunder5":
                this.thunderType = 4;
        ...
        if (!this.isIE) {
          ...
          if (t) {
            ...
            if (0 == n) return null;
            this.mustUseSelected &&
              ((4 == this.thunderType && 2 == n) ||
                (3 == this.thunderType && 1 == n)) &&
              (t = null);
          }
          return t;
        }
        if (4 == this.thunderType)
          var i = [ne.XBrowserThunder, ne.Thunder5, ne.MiniThunder];
        else if (3 == this.thunderType)
          i = [ne.XBrowserThunder, ne.Thunder5, ne.MiniThunder];
      ...
      companySetup: function (e, t) {
        try {
          var n =
            "http://analytics.xunlei.com/PV?peerid=" +
            (t = t || this.pId) +
            "&uri=" +
            e +
            "&src=" +
        ...
        for (
          var r,
            o = [
              "thunder_cid",
              "thunder_down_url",
              "thunder_down_pageurl",
              "thunder_stat_pageurl",
            ],
            a = 0;
          a < o.length;
          a++
      ...
      download: function (e, t, n, i, r) {
        ...
        if (
          ((o = this.getInstance()),
          (this.pId = this.pId ? this.pId : r || ""),
          (r = r || this.pId),
          o)
        )
          if (this.isIE) o.download(r, e, t, n, i);
          else
          ...
          (this.isIE || 0 != o) &&
            (1 != b && V(2, r), this.showSetUpInfo(r, e));
        return !1;
      },
      openWindow: function (e, t) {
        if (this.isOpenNew)
          top.location.href =
            1 == b
              ? "http://hezuo.down.xunlei.com/xunlei_hezuo_3/thunder(26597).exe"
              : e;
        else {
          var n = t || e;
      ...
      showSetUpInfo: function (e, t) {
        ...
        (e = e || this.pId),
          (n = this.isOpenNew
            ? (e.substr(0, 1),
              "http://cop.my.xunlei.com/setup/index.html?pid=" + e)
            : (this.isIE,
              this.mustUseSelected ? (this.thunderType, p(e)) : p(e))),
          m.init(e),
          this.openWindow(n, t);
      },
    };
    function ie(e, t) {
      try {
        var n =
          "http://pv.xmp.stat.xunlei.com/UPV?gs=uniondown&style=" +
          e +
          "&movie=" +
          encodeURIComponent(t) +
          "&t=" +
    ...
    function re(e, t) {
      ...
      var n = function () {
        ...
        o(t, function (n) {
          n
            ? (v.load_pc_xunlei_success(e), i({ thunderPid: t, url: e }))
      ...
      if ("Safari" != A()) {
        ...
        (a.style.visibility = "hidden"),
          ...
          d(),
          document.body.appendChild(a),
          r && a.DownLoadByThunderPlugin
            ? (v.load_pc_xunlei_success(e), a.DownLoadByThunderPlugin(e))
            : (V(2, t), n());
      } else V(2, t), n();
    }
    function oe(e) {
      try {
        ...
        return (
          (t =
            void 0 === f && "undefined" != typeof base64decode
              ? base64decode(e.substr(10))
              : f(e.substr(10))),
    ...
    (ne.WebThunder = $()),
      ...
      (ne.Thunder5.getInstance = function () {
        if (k(this._thunder) || null == this._thunder)
          try {
      ...
      (ne.Thunder5.prototype = {
        ...
        download: function (e, t, n, i, r) {
          try {
            ...
            m.init(D.pid), m.popup("generalize", t);
          }
        },
      ...
      (ne.MiniThunder.prototype = {
        initialize: function () {
          try {
            this.__thunder = new ActiveXObject(
              "ToolbarThunder.DownloadAgent.1"
            );
          } catch (e) {
            throw e;
          }
      ...
      (ne.XBrowserThunder.prototype = {
        ...
        addTask: function (e, t, n, i, r) {
          this.__thunder.OpenDownloadDlg(
            e,
            "http://www.155.com/?id=xb2",
            document.cookie
          );
        },
        commitTasks: function () {
      ...
      (ne.ffThunder.getInstance = function () {
        if (k(this._thObj) || 0 == this._thObj || null == this._thObj)
          try {
      ...
      (ne.ffThunder.prototype = {
        initialize: function () {
          if (k(this.__thObj)) {
            ...
            try {
              (this.__thObj =
                Components.classes[
                  "@xunlei.com/ThunderLoader;1"
                ].createInstance()),
                (this.__thObj = this.__thObj.QueryInterface(
                  Components.interfaces.IThunderDownload
                ));
            } catch (e) {
              throw e;
            }
        ...
        download: function (e, t, n, i, r, o) {
          ...
          3 == a && (a = o),
            ...
            (i = i || ""),
            (r = r || ""),
            this.__thObj.CallThunderClient(
              a,
              t,
              n,
              r,
      ...
      (window.onload = function () {
        ...
        if ("Chrome" == e)
          ...
          var t = j_xunlei_q(
            '<img src="chrome://thunder/content/thunder.png" width="0" height="0" />'
          );
          t.load(function () {
      ...
      (window.OnDownloadClick_Company = function (e, t, n, i, r, o, a, E) {
        return ne.companySetup(E, i), N(e, t, n, i, r, o, a), !1;
      }),
      (window.OnDownloadClick = N),
      (window.OnDownloadClick_Simple = function (e, t, n, i) {
        var r = e.getAttribute("thunderPid");
        if (
          ((window.G_thunder_pid = r),
          e.getAttribute("thunderType"),
          e.getAttribute("thunderResTitle"),
          "Android" === A() && e.setAttribute("href", "javascript:;"),
          e.setAttribute("clickid", "lianmeng_target"),
          e.setAttribute("blockid", "lianmeng_mask"),
          e.getAttribute("thunderHref"))
        )
          var o = e.getAttribute("thunderHref");
        else o = e.getAttribute(B);
        var a = o.split("?")[0].split("/").pop(),
          E =
            j_xunlei_q.inArray(a, [
              "avi",
              "rmvb",
              "rm",
              "divx",
            ...
            if (
              ...
              (function () {
                ...
                j_xunlei_q("#thunder_m_short_url").val(""),
                  ...
                  j_xunlei_q("#union_download_thunder")
                    .unbind("click")
                    .click(function () {
                      var e = A();
                      return (
                        "Firefox" == e || "Chrome" == e || "SB360" == e
                          ? re(D, E)
                          : "unknown" == e
                          ? alert(
                              unescape(
                  ...
                  j_xunlei_q("#thunder_m_gotoshoulei")
                    .unbind("click")
                    .click(function () {
                      J(8);
                    }),
                  j_xunlei_q("#thunder_m_help_link")
                    .unbind("click")
                    .click(function () {
                      J(20);
                    }),
                  j_xunlei_q("#td_m_cancel_task_status")
                    .unbind("click")
                    .click(function () {
                      return (
                        (M = clearInterval(M)),
                  ...
                  j_xunlei_q("#thunder_m_change_code,#thunder_m_check_code")
                    .unbind("click")
                    .click(function () {
                      return z(), !1;
                    }),
                  j_xunlei_q("#thunder_m_phone")
                    ...
                    .focus(function () {
                      "\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d" ==
                        j_xunlei_q("#thunder_m_phone").val() &&
                        (j_xunlei_q("#thunder_m_phone").val(""),
                        j_xunlei_q("#thunder_m_phone").addClass(
                          "thunder_m_on1"
                        ));
                    })
                    .blur(function () {
                      "" == j_xunlei_q("#thunder_m_phone").val() &&
                        (j_xunlei_q("#thunder_m_phone").removeClass(
                          "thunder_m_on1"
                        ),
                        j_xunlei_q("#thunder_m_phone").val(
                          "\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d"
                  ...
                  j_xunlei_q("#thunder_m_valid")
                    .unbind()
                    .focus(function () {
                      "\u8f93\u5165\u9a8c\u8bc1\u7801" ==
                        j_xunlei_q("#thunder_m_valid").val() &&
                        (j_xunlei_q("#thunder_m_valid").val(""),
                        j_xunlei_q("#thunder_m_valid").addClass(
                          "thunder_m_on1"
                        ));
                    })
                    .blur(function () {
                      "" == j_xunlei_q("#thunder_m_valid").val() &&
                        (j_xunlei_q("#thunder_m_valid").removeClass(
                          "thunder_m_on1"
                        ),
                        j_xunlei_q("#thunder_m_valid").val(
                          "\u8f93\u5165\u9a8c\u8bc1\u7801"
                  ...
                  j_xunlei_q("#thunder_m_phone")
                    ...
                    .keyup(function () {
                      ...
                      /^(\+86)?(13[0-9]|15[0-9]|18[0-9]|147)\d{8}$/.test(e)
                        ? (j_xunlei_q("#thunder_m_send_sms").addClass(
                            "thunder_m_on"
                          ),
                          j_xunlei_q("#thunder_m_send_sms").removeAttr(
                            "disabled"
                          ))
                        : (j_xunlei_q("#thunder_m_send_sms").removeClass(
                            "thunder_m_on"
                          ),
                          j_xunlei_q("#thunder_m_send_sms").attr(
                            "disabled",
                            "disabled"
                          ));
                    }),
                  j_xunlei_q("#thunder_m_send_sms")
                    .unbind("click")
                    .click(function () {
                      var e = j_xunlei_q("#thunder_m_phone").val();
                      if (
                ...
                var r = l(),
                  ...
                  s = "fixed";
                (U || "backcompat" == document.compatMode.toLowerCase()) &&
                  ((s = "absolute"),
                  (o =
                    r.clientWidth / 2 -
                    200 +
                  ...
                  (u.style.top = Math.max(
                    document.documentElement.scrollTop,
                    document.body.scrollTop
                  ))),
                  i.css({ left: o, top: a, position: s, zIndex: 9e9 }),
                  document.body.appendChild(u),
                  J(3);
              })(),
                (U || "backcompat" == document.compatMode.toLowerCase()) &&
                  ((u.style.height = Math.max(
      ...
      (window.firefoxThunderDownload = function (e) {
        if (!x) {
          if (1 == y)
            document.write(
              '<object id="pluginobj" type="application/x-thunder-XBrowserAgent"><font color=#ffffff size=0>1</font></object>'
            );
          else {
            var t = document.createElement("object");
            t.setAttribute("id", "pluginobj"),
          ...
          for (var n = 0; n < navigator.plugins.length; n++)
            if ("npXBrowserAgent.dll" == navigator.plugins[n].filename)
              var i = !0;
        }
        return i;
      }),
      ...
      j_xunlei_q(document).ready(function () {
        j_xunlei_q("a[thunderHref]").each(function () {
          ...
          e.attr(B, e.attr("thunderHref")), e.removeAttr("thunderHref");
        }),
          "Android" == A() &&
            j_xunlei_q("a[" + B + "]").each(function () {
              var e = j_xunlei_q(this);
              e.attr("href", e.attr(B)), e.removeAttr("thunderHref");
            });
      }),
  ...
  function (e, t) {
    e.exports = function (e) {
      ...
      function i(e, i, r, o, a, E, s) {
        var C;
        return (e = n(e, n(n(((C = i) & r) | (~C & o), a), s))), n(t(e, E), i);
      }
      function r(e, i, r, o, a, E, s) {
        var C;
        return (e = n(e, n(n((i & (C = o)) | (r & ~C), a), s))), n(t(e, E), i);
      }
      function o(e, i, r, o, a, E, s) {
        return (e = n(e, n(n(i ^ r ^ o, a), s))), n(t(e, E), i);
      }
      function a(e, i, r, o, a, E, s) {
        return (e = n(e, n(n(r ^ (i | ~o), a), s))), n(t(e, E), i);
      }
      function E(e) {
        var t,
          n = "",
      ...
      for (
        ...
        (C = l),
          ...
          (l = r(
            l,
            (A = i(A, c, F, l, d[s + 15], 22, 1236535329)),
            c,
            F,
            d[s + 1],
            5,
          ...
          (l = o(
            l,
            (A = r(A, c, F, l, d[s + 12], 20, 2368359562)),
            c,
            F,
            d[s + 5],
            4,
          ...
          (l = a(
            l,
            (A = o(A, c, F, l, d[s + 2], 23, 3299628645)),
            c,
            F,
            d[s + 0],
            6,
      ...
      (r = function () {
        ...
        return (
          ...
          (Q.prototype._eachEntry = function (e, t) {
            ...
            if (i === g) {
              ...
              if (r === v && e._state !== b)
                ...
                var o = new n(y);
                T(o, e, r), this._willSettleAt(o, t);
              } else
                this._willSettleAt(
                  new n(function (t) {
                    return t(e);
          ...
          (Q.prototype._settledAt = function (e, t, n) {
            var i = this.promise;
            i._state === b &&
              (this._remaining--, e === x ? O(i, n) : (this._result[t] = n)),
      ...
      (B.prototype.request = function (e) {
        ...
        i.forEach(["post", "put", "patch"], function (e) {
          B.prototype[e] = function (t, n, i) {
            return this.request(E(i || {}, { method: e, url: t, data: n }));
          };
        }),
        (e.exports = B);
    }.call(this, n(9)));
              ...
              i.openComfirm({
                contentHtml:
                  "\n        <div class='xl_ios_comfirm_wrapper'>\n          <div class='xl_ios_comfirm_shadow'></div>\n          <div class='xl_ios_comfirm'>\n            <p class='title'>\u4fdd\u5b58\u8d44\u6e90\u5230\u8fc5\u96f7</p>\n            <div class='desc'>\n              <p><span>1</span>\u8d44\u6e90\u5b58\u5165\u8fc5\u96f7\u4e91\u76d8\u7f51\u9875\u7248</p>\n              <p><span>2</span>\u6253\u5f00\u8fc5\u96f7app\u9ad8\u901f\u4e0b\u8f7d</p>\n            </div>\n            <div class='content-wrap'>\n              <div class='content'>\n                <img src='"
                    ...
                    .concat(
                      n,
                      '</p>\n                  <p class="title-item title-link" title="'
                    )
                    .concat(t, '">')
                    .concat(
                      t,
                ...
                comfirmHandler: function () {
                  r.reportSend("page_click", {
                    ...
                    (window.location.href = ""
                      .concat("https://pan.xunlei.com/", "?taskurl=")
                      .concat(decodeURIComponent(t), "&unionId=")
                      .concat(E));
                },
              });
          })({ url: t, name: n, unionId: E });
  ...
  function (e, t, n) {
    ...
    function D(e, t, n) {
      ...
      if ((p.indexOf(D.LINK) < 0 && (p += D.LINK), null == l))
        try {
          l = thunderAppend;
        } catch (e) {
          l = !1;
        }
      if ((D.isDebug && alert(l), "" == u || void 0 === u))
        try {
          u = thunderLinkStyle;
        } catch (e) {
          u = "";
      ...
      "" != u && (u = u.replace(/\\/g, "\\"));
      var v =
        ".srt|.mkv|.jad|.bis|.bin|.sw|.reg|.sisx|.sis|.eet|.xls|.nh|.kdh|.ppt|.mdf|.wmp|.doc|.pdf|.chm|.asf|.avi|.exe|.iso|.mp3|.mpeg|.mpg|.mpga|.ra|.rar|.rm|.rmvb|.tar|.wma|.wmv|.zip|.swf|.mp4|.3gp|.torrent|.txt|.jar|.mov|.wav|.eip";
      if (void 0 === E || null == E) {
        try {
          E = o.pid;
        } catch (e) {
        ...
        if ("" == E || null == typeof E || isNaN(E))
          return D.isDebug && alert("Pid is not provided!"), !1;
      }
      if (null == C || void 0 === C)
        try {
          C = thunderPath;
      ...
      var g = j_xunlei_q(document.links).filter(".thunder-link"),
        _ =
          ((v = v.replace(/\./g, "\\.")),
          /^http:\/\/|https:\/\/|ftp:\/\/|mms:\/\/[\s\S]*?$/i),
        y = /^http:\/\/|https:\/\/|ftp:\/\/[\s\S]*?$/i;
      "Android" == a() &&
        (_ = /^http:\/\/|https:\/\/|ftp:\/\/|magnet:|ed2k:|mms:\/\/[\s\S]*?$/i);
      var b = g.length,
        w = 0,
        x = 0;
      F <= 0 && (F = b);
      for (var k = 0; k < b; k++)
        if (g[k + w].href) {
          ...
          if ("#" == g[k + w].href.substr(g[k + w].href.length - 1, 1) && j) {
            D.isDebug &&
              (alert("ThunderHref:" + j), alert("href:" + g[k + w].href));
            continue;
          }
          ...
          var I = "",
            S = "";
          if (0 == T.indexOf("thunder://"))
            (S = T), D.isDebug && alert("thunderLinker![" + S + "]");
          else if (_.test(T))
            I = y.test(T)
              ? T.indexOf("?") > 0
                ? T + "&" + s(T)
            ...
            if ("string" == typeof C)
              T.toLowerCase().indexOf("/" + C) > -1 &&
                ((I = T), D.isDebug && alert("other://String Path Valid!"));
            else if (C.test) {
              var N = C.test(T);
              T.indexOf("attachment") > 0 &&
                D.isDebug &&
                alert(String(C) + ".test('" + T + "')=" + String(N)),
                null != T.match(C)
                  ? ((I = T),
                    D.isDebug &&
                      alert("**********************RegEx*********************"))
                    ...
                    (g[k + w].insertAdjacentHTML(
                      ...
                      p.replace(
                        ...
                        h +
                          ...
                          "' thunderPid='" +
                          E +
                          "' thunderType='' thunderResTitle='' onClick='return OnDownloadClick_Simple(this,2)' oncontextmenu='ThunderNetwork_SetHref(this)'>" +
                          u.replace(D.TITLE, O.innerHTML) +
                          "</a>"
                      ) + d
                    ),
                    w++,
                    x++)
                  : (O.setAttribute("thunderPid", E),
                    O.setAttribute("thunderType", ""),
                    O.setAttribute("thunderResTitle", O.innerHTML),
                    O.setAttribute(
                      "onclick",
                  ...
                  (g[k + w].insertAdjacentHTML(
                    ...
                    p.replace(
                      ...
                      h +
                        ...
                        "' thunderPid='" +
                        E +
                        "' thunderType='' thunderResTitle='' onClick='return OnDownloadClick_Simple(this,2)' oncontextmenu='ThunderNetwork_SetHref(this)'><font color='red'>" +
                        A +
                        "</font></a>"
                    ) + d
                  ),
        ...
        (document.onreadystatechange = function () {
          if ("complete" == document.readyState) {
            ...
            if (document.body && D.auto) {
              var e = function () {};
              "function" == typeof document.body.onload &&
                (e = document.body.onload),
                (document.body.onload = function () {
                  e(), D();
                });
            } else if (D.isDebug && !document.body)
              for (e in document) alert(e);
          }
        }),
      (e.exports = D);
  },
  function (e, t) {
    ...
    function i(e) {
      return (function (e) {
        for (
          var t = n ? "0123456789ABCDEF" : "0123456789abcdef", i = "", r = 0;
          r < 4 * e.length;
          r++
        )
          i +=
        ...
        (function (e) {
          ...
          (function (e) {
            for (
              var t = 1 + ((e.length + 8) >> 6), n = new Array(16 * t), i = 0;
              i < 16 * t;
              i++
            )
              n[i] = 0;
            for (i = 0; i < e.length; i++)
              n[i >> 2] |= e.charCodeAt(i) << (24 - 8 * (3 & i));
            return (
              (n[i >> 2] |= 128 << (24 - 8 * (3 & i))),
              (n[16 * t - 1] = 8 * e.length),
              n
    ...
    t.hex_sha1 = function (e) {
      return (
        ...
        i(
          (function (e) {
            var t, n, i, r;
            for (t = "", i = e.length, n = 0; n < i; n++)
              (r = e.charCodeAt(n)) >= 1 && r <= 127
                ? (t += e.charAt(n))
                : r > 2047
                ? ((t += String.fromCharCode(224 | ((r >> 12) & 15))),
                  (t += String.fromCharCode(128 | ((r >> 6) & 63))),
                  (t += String.fromCharCode(128 | ((r >> 0) & 63))))
                : ((t += String.fromCharCode(192 | ((r >> 6) & 31))),
                  (t += String.fromCharCode(128 | ((r >> 0) & 63))));
            return t;
          })((e = e + "NSU4NSU4Q"))
        ).substr(0, 10)
